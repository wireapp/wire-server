Default `wire-ingress` to TLS 1.3 with `X25519MLKEM768` hybrid key agreement and `X25519` as classical fallback. TLS 1.2 requires lowering the minimum version and adding
