...
type RowBrigClients = (Maybe UUID, Maybe Text, Maybe Int32, Maybe Text, Maybe TODO, Maybe Text, Maybe Double, Maybe Double, Maybe Text, Maybe UTCTime, Maybe Int32)
...
type RowBrigProperties = (Maybe UUID, Maybe Text, Maybe TODO)
...
type RowBrigRichInfo = (Maybe UUID, Maybe TODO)
...
type RowBrigUser = (Maybe UUID, Maybe [Double], Maybe Int32, Maybe Bool, Maybe [TODO], Maybe Text, Maybe Text, Maybe UTCTime, Maybe Text, Maybe Text, Maybe Int32, Maybe Text, Maybe TODO, Maybe Text, Maybe [TODO], Maybe UUID, Maybe Bool, Maybe UUID, Maybe Text, Maybe Int32, Maybe UUID)
...
type RowBrigUserKeysHash = (Maybe TODO, Maybe Int32, Maybe UUID)
...
type RowGalleyLegalholdService = (Maybe UUID, Maybe Text, Maybe TODO, Maybe TODO, Maybe Blob)
...
type RowGalleyTeamNotifications = (Maybe UUID, Maybe UUID, Maybe TODO)
...
type RowGundeckNotifications = (Maybe UUID, Maybe UUID, Maybe (Cassandra.Set Text), Maybe TODO)
...
type RowGundeckPush = (Maybe Text, Maybe Text, Maybe Int32, Maybe Text, Maybe TODO, Maybe UUID)
...
type RowGundeckUserPush = (Maybe UUID, Maybe Text, Maybe Text, Maybe Int32, Maybe Text, Maybe Text, Maybe TODO)
...
type RowSparIdp = (Maybe UUID, Maybe [TODO], Maybe Text, Maybe [Text], Maybe TODO, Maybe UUID, Maybe Text, Maybe UUID)
