...
charts=(brig cannon gundeck spar cargohold proxy cassandra-migrations elasticsearch-index federator backoffice integration wire-server-enterprise)
...
# Galley and BackgroundWorker are inlined into the umbrella chart.
