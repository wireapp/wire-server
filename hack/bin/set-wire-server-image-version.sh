...
charts=(gundeck spar proxy cassandra-migrations elasticsearch-index federator backoffice integration wire-server-enterprise)
...
# Brig, Galley, Cargohold, BackgroundWorker, and Cannon are inlined into the umbrella chart.
