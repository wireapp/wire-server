...
charts=(brig cannon gundeck spar cargohold proxy cassandra-migrations elasticsearch-index federator backoffice background-worker integration wire-server-enterprise)
...
# galley has been inlined into the umbrella chart
