...
, schema-profunctor, servant-server, servant-swagger
, string-conversions, swagger2, tasty, tasty-hunit
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    schema-profunctor servant-server servant-swagger string-conversions
    swagger2 text time tinylog types-common unordered-containers
    wire-api
  ];
  testHaskellDepends = [
    aeson attoparsec base bytestring bytestring-conversion containers
    imports QuickCheck swagger2 tasty tasty-hunit tasty-quickcheck text
