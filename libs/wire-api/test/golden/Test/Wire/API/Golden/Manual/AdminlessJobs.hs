...
testObject_ScheduledJobPayload_MeetingsCleanup_1 :: ScheduledJobPayload
testObject_ScheduledJobPayload_MeetingsCleanup_1 = MeetingsCleanup MeetingsCleanupJob

testObject_ScheduledJobPayload_AdminlessDeletion_1 :: ScheduledJobPayload
testObject_ScheduledJobPayload_AdminlessDeletion_1 = AdminlessDeletion testObject_AdminlessDeletionJob_1

testObject_ScheduledJobPayload_AdminlessReminder_1 :: ScheduledJobPayload
testObject_ScheduledJobPayload_AdminlessReminder_1 = AdminlessReminder testObject_AdminlessReminderJob_1
