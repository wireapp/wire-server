...
testObject_NewPasswordReset_user_6 =
  NewPasswordReset
    ( Left
        ( Email
            { emailLocal = "\152884",
              emailDomain =
                "pkTt\1001860,K\1102090C\53037\&2\1035134\1067347s\n\r\1067827\1098299+\41929\DEL:\GS[\194887MbEC\NUL"
            }
        )
    )

testObject_NewPasswordReset_user_7 :: NewPasswordReset
testObject_NewPasswordReset_user_7 =
  NewPasswordReset
    ( Left
        ( Email
            { emailLocal = "N\189885V'}\985226\a3",
              emailDomain = "*\SYNjF\18337\"~Z\58036\41350z\138497bN\131493\8948)I3\t\EOT\1042981\1077394,\DC4"
            }
        )
    )
...
testObject_NewPasswordReset_user_8 =
  NewPasswordReset
    ( Left
        ( Email
            { emailLocal = "(a\34126'CKj\ESC\EM\1051534",
              emailDomain = "?\986742D\135082\1012625\&7\1076206eh\18902gS\1090140}\1073865n_"
            }
        )
    )

testObject_NewPasswordReset_user_9 :: NewPasswordReset
testObject_NewPasswordReset_user_9 =
  NewPasswordReset
    ( Left
        ( Email
            { emailLocal = "\ETXji\b\a\995206\1001044\120664'\8103k\RS+",
              emailDomain =
                "\FS:\ETX\f\1071180\&5\22603t\135200>\174985IE\1065671M\DC2g\SUBAO\159061\&3\"\1000816H\54341c\129145\44991\&6"
            }
        )
    )

testObject_NewPasswordReset_user_10 :: NewPasswordReset
testObject_NewPasswordReset_user_10 =
  NewPasswordReset
    ( Left
        ( Email
            { emailLocal = "P\1065495m#\bo\n?n\170449\RSnr\"^c\1033506\\'g\53693l",
              emailDomain = "/?\17268\1093472\SUBt\ETXv"
            }
        )
    )
...
testObject_NewPasswordReset_user_12 =
  NewPasswordReset
    (Left (Email {emailLocal = "9G\144799", emailDomain = "\986254\SYN\1003426\182313\SI\STX\US\NAKgP \987001"}))
...
testObject_NewPasswordReset_user_15 =
  NewPasswordReset
    ( Left
        (Email {emailLocal = "\139234\21486\ETX 9\ESC0!\ETX\1007793\ETXxBxL=DL\25894/\r\7651", emailDomain = "$56f!/"})
    )

testObject_NewPasswordReset_user_16 :: NewPasswordReset
testObject_NewPasswordReset_user_16 =
  NewPasswordReset
    (Left (Email {emailLocal = "w\SOHspQ(\25060\EOT\"\\\ETXrbE\n5\111158D", emailDomain = "ps!\t\178810"}))
