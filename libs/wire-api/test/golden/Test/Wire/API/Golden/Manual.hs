...
tests =
  testGroup
    ...
    [ testGroup "NewApp" $
      ...
      testGroup "AdminlessSetupJob" $
        testObjects
          [ (testObject_AdminlessSetupJob_1, "testObject_AdminlessSetupJob_1.json"),
            (testObject_AdminlessSetupJob_2, "testObject_AdminlessSetupJob_2.json")
          ],
      ...
      testGroup "UserGroupPage" $
        testObjects
          [ (testObject_UserGroupPage_1, "testObject_UserGroupPage_1.json"),
            ...
            (testObject_UserGroupPage_3, "testObject_UserGroupPage_3.json")
          ],
      ...
      testGroup "UserEvent" $
        testObjects
          [ (testObject_UserEvent_1, "testObject_UserEvent_1.json"),
            ...
            (testObject_UserEvent_19, "testObject_UserEvent_19.json")
          ],
