...
testObject_InvitationRequest_team_1 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.NN, lCountry = Nothing}),
      role = Just RoleOwner,
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "/Y\164738\v}?" "\992922\1041097\178160\SO\1036829"
    }
...
testObject_InvitationRequest_team_2 =
  InvitationRequest
    { locale =
      ...
      role = Nothing,
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "E" "/"
    }
...
testObject_InvitationRequest_team_3 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\SYN" "\1107957Z\1034246we\1105089"
    }
...
testObject_InvitationRequest_team_4 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "" ""
    }
...
testObject_InvitationRequest_team_5 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = unsafeEmailAddress "" "\DEL\15723"
    }
...
testObject_InvitationRequest_team_6 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\6559^\EOT\DC4" ".}\177921"
    }
...
testObject_InvitationRequest_team_7 =
  InvitationRequest
    { locale = Nothing,
      role = Just RoleAdmin,
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "g\NUL-J\65751" "\ETXH\1033960eU"
    }
...
testObject_InvitationRequest_team_8 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\1031836\SUBh\ETBb\SI" ""
    }
...
testObject_InvitationRequest_team_9 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\\\175244" ""
    }
...
testObject_InvitationRequest_team_10 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\1010285\f\ACK\DLE^s" "d"
    }
...
testObject_InvitationRequest_team_11 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.SI, lCountry = Nothing}),
      ...
      inviteeEmail = unsafeEmailAddress "\SOH\NUL\1016497nJ" "t\STX."
    }
...
testObject_InvitationRequest_team_12 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "\1108640\1081336" ""
    }
...
testObject_InvitationRequest_team_13 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = unsafeEmailAddress "\NULr" "c,"
    }
...
testObject_InvitationRequest_team_14 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = unsafeEmailAddress "" "\v"
    }
...
testObject_InvitationRequest_team_15 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = unsafeEmailAddress "U" "\1082936"
    }
...
testObject_InvitationRequest_team_16 =
  InvitationRequest
    { locale =
      ...
      role = Just RoleAdmin,
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "\22759" "\SOH"
    }
...
testObject_InvitationRequest_team_17 =
  InvitationRequest
    { locale =
      ...
      role = Just RoleExternalPartner,
      inviteeName = Nothing,
      inviteeEmail = unsafeEmailAddress "3\fC\ETB\"" "\SOH0x\120290"
    }
...
testObject_InvitationRequest_team_18 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.KU, lCountry = Nothing}),
      ...
      inviteeEmail = unsafeEmailAddress "\b\ACKb\n0" "UJj&\38833"
    }
...
testObject_InvitationRequest_team_19 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = unsafeEmailAddress "{:\1084510\43947" "q{(>}\177749"
    }
...
testObject_InvitationRequest_team_20 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = unsafeEmailAddress "\1086165X|J{" "^"
    }
