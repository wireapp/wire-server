...
testObject_InvitationRequest_team_1 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.NN, lCountry = Nothing}),
      role = Just RoleOwner,
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "/Y\164738\v}?", emailDomain = "\992922\1041097\178160\SO\1036829"}
    }
...
testObject_InvitationRequest_team_2 =
  InvitationRequest
    { locale =
      ...
      role = Nothing,
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "E", emailDomain = "/"}
    }
...
testObject_InvitationRequest_team_3 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\SYN", emailDomain = "\1107957Z\1034246we\1105089"}
    }
...
testObject_InvitationRequest_team_4 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "", emailDomain = ""}
    }
...
testObject_InvitationRequest_team_5 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = Email {emailLocal = "", emailDomain = "\DEL\15723"}
    }
...
testObject_InvitationRequest_team_6 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\6559^\EOT\DC4", emailDomain = ".}\177921"}
    }
...
testObject_InvitationRequest_team_7 =
  InvitationRequest
    { locale = Nothing,
      role = Just RoleAdmin,
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "g\NUL-J\65751", emailDomain = "\ETXH\1033960eU"}
    }
...
testObject_InvitationRequest_team_8 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\1031836\SUBh\ETBb\SI", emailDomain = ""}
    }
...
testObject_InvitationRequest_team_9 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\\\175244", emailDomain = ""}
    }
...
testObject_InvitationRequest_team_10 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\1010285\f\ACK\DLE^s", emailDomain = "d"}
    }
...
testObject_InvitationRequest_team_11 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.SI, lCountry = Nothing}),
      ...
      inviteeEmail = Email {emailLocal = "\SOH\NUL\1016497nJ", emailDomain = "t\STX."}
    }
...
testObject_InvitationRequest_team_12 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "\1108640\1081336", emailDomain = ""}
    }
...
testObject_InvitationRequest_team_13 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = Email {emailLocal = "\NULr", emailDomain = "c,"}
    }
...
testObject_InvitationRequest_team_14 =
  InvitationRequest
    { locale =
      ...
      inviteeEmail = Email {emailLocal = "", emailDomain = "\v"}
    }
...
testObject_InvitationRequest_team_15 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = Email {emailLocal = "U", emailDomain = "\1082936"}
    }
...
testObject_InvitationRequest_team_16 =
  InvitationRequest
    { locale =
      ...
      role = Just RoleAdmin,
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "\22759", emailDomain = "\SOH"}
    }
...
testObject_InvitationRequest_team_17 =
  InvitationRequest
    { locale =
      ...
      role = Just RoleExternalPartner,
      inviteeName = Nothing,
      inviteeEmail = Email {emailLocal = "3\fC\ETB\"", emailDomain = "\SOH0x\120290"}
    }
...
testObject_InvitationRequest_team_18 =
  InvitationRequest
    { locale = Just (Locale {lLanguage = Language Data.LanguageCodes.KU, lCountry = Nothing}),
      ...
      inviteeEmail = Email {emailLocal = "\b\ACKb\n0", emailDomain = "UJj&\38833"}
    }
...
testObject_InvitationRequest_team_19 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = Email {emailLocal = "{:\1084510\43947", emailDomain = "q{(>}\177749"}
    }
...
testObject_InvitationRequest_team_20 =
  InvitationRequest
    { locale = Nothing,
      ...
      inviteeEmail = Email {emailLocal = "\1086165X|J{", emailDomain = "^"}
    }
