...
import Wire.API.User.RichInfo (RichField (RichField, richFieldType, richFieldValue), RichInfoMapAndList (..), mkRichInfoMapAndList)
...
testObject_RichInfoMapAndList_user_17 = mkRichInfoMapAndList []
