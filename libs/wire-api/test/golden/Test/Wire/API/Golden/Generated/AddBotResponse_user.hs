...
testObject_AddBotResponse_user_1 =
  AddBotResponse
    { rsAddBotId = (BotId . Id) (fromJust (UUID.fromString "00000003-0000-0004-0000-000300000001")),
      ...
      rsAddBotEvent =
        Event
          (Qualified (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000200000003"))) (Domain "faraway.default.domain"))
          Nothing
          (Qualified (Id (fromJust (UUID.fromString "00000004-0000-0004-0000-000400000004"))) (Domain "faraway.default.domain"))
...
testObject_AddBotResponse_user_2 =
  AddBotResponse
    { rsAddBotId = (BotId . Id) (fromJust (UUID.fromString "00000001-0000-0003-0000-000200000004")),
      ...
      rsAddBotEvent =
        Event
          (Qualified (Id (fromJust (UUID.fromString "00000000-0000-0002-0000-000300000001"))) (Domain "faraway.default.domain"))
          Nothing
          (Qualified (Id (fromJust (UUID.fromString "00000004-0000-0000-0000-000300000001"))) (Domain "faraway.default.domain"))
