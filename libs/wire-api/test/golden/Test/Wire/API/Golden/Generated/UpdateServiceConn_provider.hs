...
import Data.Misc (HttpsUrl (HttpsUrl), plainTextPasswordLegacyUnsafe)
...
testObject_UpdateServiceConn_provider_6 =
  UpdateServiceConn
    { updateServiceConnPassword = plainTextPasswordLegacyUnsafe "n\EM\1097578J\154077\136250S(G\1099243}\ENQa\SO\1048917Cbmi",
      updateServiceConnUrl =
        Just
          ( coerce
              URI
