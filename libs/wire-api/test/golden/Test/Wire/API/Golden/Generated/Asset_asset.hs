...
testObject_Asset_asset_1 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "0000004b-0000-0017-0000-003e00000033"))) AssetExpiring) (Domain "default.domain"))
...
testObject_Asset_asset_2 =
  mkAsset
    (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000008-0000-006c-0000-001900000036"))) AssetEternalInfrequentAccess) (Domain "default.domain"))
...
testObject_Asset_asset_3 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000055-0000-0071-0000-002e00000020"))) AssetEternal) (Domain "default.domain"))
...
testObject_Asset_asset_4 =
  mkAsset
    (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000063-0000-0044-0000-003000000059"))) AssetEternalInfrequentAccess) (Domain "default.domain"))
...
testObject_Asset_asset_5 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000019-0000-005b-0000-001d00000056"))) AssetVolatile) (Domain "default.domain"))
...
testObject_Asset_asset_6 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "0000000e-0000-0046-0000-00560000005e"))) AssetPersistent) (Domain "default.domain"))
    & assetExpires .~ fmap read (Just "1864-05-25 01:19:16.676 UTC")
    & assetToken .~ Nothing

testObject_Asset_asset_7 :: Asset
testObject_Asset_asset_7 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000013-0000-002e-0000-003000000042"))) AssetEternal) (Domain "default.domain"))
...
testObject_Asset_asset_8 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000073-0000-003e-0000-00120000000c"))) AssetEternal) (Domain "default.domain"))
    & assetExpires .~ fmap read Nothing
    & assetToken .~ Nothing

testObject_Asset_asset_9 :: Asset
testObject_Asset_asset_9 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000006-0000-004b-0000-004f00000025"))) AssetPersistent) (Domain "default.domain"))
    & assetExpires .~ fmap read (Just "1864-05-21 01:34:09.726 UTC")
    & assetToken .~ Nothing

testObject_Asset_asset_10 :: Asset
testObject_Asset_asset_10 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000065-0000-0080-0000-003400000061"))) AssetEternal) (Domain "default.domain"))
    & assetExpires .~ fmap read Nothing
    & assetToken .~ Nothing
...
testObject_Asset_asset_11 =
  mkAsset
    (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000014-0000-0077-0000-001e00000076"))) AssetEternalInfrequentAccess) (Domain "default.domain"))
...
testObject_Asset_asset_12 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "0000001d-0000-0076-0000-003800000021"))) AssetPersistent) (Domain "default.domain"))
    & assetExpires .~ fmap read Nothing
    & assetToken .~ Nothing
...
testObject_Asset_asset_13 =
  mkAsset
    (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000030-0000-0036-0000-003c0000000a"))) AssetEternalInfrequentAccess) (Domain "default.domain"))
...
testObject_Asset_asset_14 =
  mkAsset
    (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000047-0000-0012-0000-005500000062"))) AssetEternalInfrequentAccess) (Domain "default.domain"))
...
testObject_Asset_asset_15 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000030-0000-0074-0000-00660000004c"))) AssetPersistent) (Domain "default.domain"))
    & assetExpires .~ fmap read Nothing
    & assetToken .~ Nothing

testObject_Asset_asset_16 :: Asset
testObject_Asset_asset_16 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000048-0000-0051-0000-005d00000070"))) AssetVolatile) (Domain "default.domain"))
    & assetExpires .~ fmap read (Just "1864-05-04 02:19:12.52 UTC")
    & assetToken .~ Nothing

testObject_Asset_asset_17 :: Asset
testObject_Asset_asset_17 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000017-0000-000d-0000-00680000003e"))) AssetPersistent) (Domain "default.domain"))
    & assetExpires .~ fmap read (Just "1864-04-09 17:00:39.763 UTC")
    & assetToken .~ Nothing

testObject_Asset_asset_18 :: Asset
testObject_Asset_asset_18 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "0000003e-0000-0032-0000-004d00000070"))) AssetEternal) (Domain "default.domain"))
    & assetExpires .~ fmap read (Just "1864-04-12 20:53:21.25 UTC")
    & assetToken .~ Nothing

testObject_Asset_asset_19 :: Asset
testObject_Asset_asset_19 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000021-0000-0062-0000-002a0000006b"))) AssetVolatile) (Domain "default.domain"))
    & assetExpires
      .~ fmap read Nothing
    & assetToken
...
testObject_Asset_asset_20 =
  mkAsset (Qualified (AssetKeyV3 (Id (fromJust (UUID.fromString "00000053-0000-0072-0000-001700000047"))) AssetVolatile) (Domain "default.domain"))
