...
testObject_NewProvider_provider_1 =
  NewProvider
    { newProviderName = Name {fromName = "\1017845\&8\1098296\58272:(\DLE\1000399f\1005296\a\13015\1080816\&4K\42948L"},
      newProviderEmail = unsafeEmailAddress "Y" "\1109538>\SI_\SUB0",
      newProviderUrl =
        coerce
          URI
...
testObject_NewProvider_provider_2 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "S\999953k\RS\49099G" "T,",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_3 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "y\SO\DEL\120818" " e",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_4 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\993799'g\n" "\1046285Z\1045773\GS",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_5 =
  NewProvider
    { newProviderName = Name {fromName = "\169186\DC24)\1066115\ENQv7\r\ETXp\DLEeI\62252\184208\&4SD^\68867;9*"},
      newProviderEmail = unsafeEmailAddress "\1086513" "",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_6 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\1111012\149049\1059090\137222\NAK" "\ETX\1058787\ENQ-H",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_7 =
  NewProvider
    { newProviderName = Name {fromName = "^\1061540\ENQMSO\1061583\&0\STX"},
      newProviderEmail = unsafeEmailAddress "e\DC1\8331c[i" "2CTG\US\r",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_8 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\SUB#\EMdlb" "\ETB\985485\NAK^",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_9 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "8-\SYN\\" "\EOT\50704~#",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_10 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "_e_v\SUBL" "\v4",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_11 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\a*\RS_" "6\1030075\a\f#9",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_12 =
  NewProvider
    { newProviderName = Name {fromName = "E\DEL\DC3MNO\33205\EOTZ\1042578\NULI\9109\&5e3"},
      newProviderEmail = unsafeEmailAddress "" "d*\1049690jA}",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_13 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "B\RSvq\1063673\&7" "\44409",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_14 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "%a\1037687" "\SI\"{",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_15 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\177675-\\" "",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_16 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\ESC\SOFk2" ";",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_17 =
  NewProvider
    { newProviderName = Name {fromName = "\DC4*43\1113144Xg\NAK\SO;\NAKJ}\1043632wZJ\1028947.=c_\f\DLEI\83112\bmU\SInT"},
      newProviderEmail = unsafeEmailAddress "lW6/" "fD\1093349",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_18 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "=\DLE" "m",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_19 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "\1104111\CANOe\\\b" "\1081997\EOT\1104647*\ETB(",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
...
testObject_NewProvider_provider_20 =
  NewProvider
    { newProviderName =
      ...
      newProviderEmail = unsafeEmailAddress "" "\DC4:",
      newProviderUrl =
        coerce
          URI
            { uriScheme = Scheme {schemeBS = "https"},
