  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000000-0000-0008-0000-000000000004"))),
          ...
          providerEmail = Email {emailLocal = "", emailDomain = "\STX7\99332"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000004-0000-0001-0000-000800000000"))),
          ...
          providerEmail = Email {emailLocal = "", emailDomain = "_ \1060474\990125"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000000-0000-0002-0000-000400000004"))),
          ...
          providerEmail = Email {emailLocal = "h\161768\t\1097554G", emailDomain = "\134955/\DC4"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000008-0000-0000-0000-000600000008"))),
          ...
          providerEmail = Email {emailLocal = "\1019096", emailDomain = "_q[w\NUL("},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000003-0000-0006-0000-000800000001"))),
          ...
          providerEmail = Email {emailLocal = "\1095636\995243\DELb^", emailDomain = "\60455\n\1007982l"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000005-0000-0004-0000-000700000008"))),
          ...
          providerEmail = Email {emailLocal = "\DC2,[", emailDomain = "\31313/0"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000004-0000-0006-0000-000100000002"))),
          ...
          providerEmail = Email {emailLocal = "\142265.\EMk\1035106", emailDomain = "n}\190773\n"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000004-0000-0008-0000-000500000008"))),
          ...
          providerEmail = Email {emailLocal = "gd\1046608\1072562e", emailDomain = ""},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000001-0000-0003-0000-000700000004"))),
          ...
          providerEmail = Email {emailLocal = "", emailDomain = "W"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000007-0000-0004-0000-000100000000"))),
          ...
          providerEmail = Email {emailLocal = "Z\148819", emailDomain = "!\1045867\69665\f\23358"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000006-0000-0005-0000-000800000004"))),
          ...
          providerEmail = Email {emailLocal = "\SOH#\134551", emailDomain = "u\SO\19353"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000001-0000-0006-0000-000300000005"))),
          ...
          providerEmail = Email {emailLocal = "\2355\CAN:c5", emailDomain = "G\1049614E`"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000008-0000-0001-0000-000300000001"))),
          ...
          providerEmail = Email {emailLocal = "\180899", emailDomain = "\34121z\16843'"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000007-0000-0006-0000-000600000008"))),
          ...
          providerEmail = Email {emailLocal = "", emailDomain = "\b<u\165127"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
  ...
  ProviderProfile
    ( Provider
        { providerId = (Id (fromJust (UUID.fromString "00000006-0000-0005-0000-000200000008"))),
          ...
          providerEmail = Email {emailLocal = "\46253`kmI", emailDomain = "\1104187"},
          providerUrl =
            coerce
              URI
                { uriScheme = Scheme {schemeBS = "https"},
