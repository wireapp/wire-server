...
testObject_BotUserView_provider_1 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000100000002"))),
      ...
      botUserViewHandle = Just (Handle {fromHandle = "fpa2vx"}),
...
testObject_BotUserView_provider_2 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000002-0000-0003-0000-000500000001"))),
      ...
      botUserViewHandle = Just (Handle {fromHandle = "mz"}),
...
testObject_BotUserView_provider_6 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000004-0000-0007-0000-000000000002"))),
      ...
      botUserViewColour = ColourId {fromColourId = -5},
      botUserViewHandle =
        Just (Handle {fromHandle = "uz3cgdxtkev-40624m0eh_y06g-c9isv-ob.r84rneq2vm.440nxc_n44_3d0-6u9l7"}),
...
testObject_BotUserView_provider_7 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000006-0000-0003-0000-000800000002"))),
      ...
      botUserViewHandle = Just (Handle {fromHandle = "-c7916.."}),
    ...
    { botUserViewId = (Id (fromJust (UUID.fromString "00000008-0000-0008-0000-000500000003"))),
      ...
      botUserViewHandle =
        Just
          ( Handle
              { fromHandle =
                  "p1brgaim3u1-2grwj1-ij_m1p0_t.vqk92o0nxg1t928_r-qj58xhcg-ai.zfj9q63h2nno5om5kt38oo58vx81b27f4f_kzra9r6.56-gfb2ymhl3c2na7_pmsio59vezrgq-09g8yd_4hv2pdj.5rm62cp39qb_v7-x3q2a2yom-so1t-cpi2x5x6o1hwabe3ruci82gfar.czdlwukqi8dhvdse3b5o4_diowoozf1p5mcget81fa_zv8eff"
              }
          ),
    ...
    { botUserViewId = (Id (fromJust (UUID.fromString "00000007-0000-0005-0000-000100000001"))),
      ...
      botUserViewHandle =
        Just
          ( Handle
              { fromHandle =
                  "qsbule-m4sswyr84uqh0.nzlyuher98kp-fkxn7xydbazbdeg-j-8sco56tr4i928muztpmzc-6nlzi4ob.-4lyhr6ra.wsc7jn6wv.l1mno080ax890jgd7.u_-2.-4v3n8"
              }
          ),
...
testObject_BotUserView_provider_10 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000008-0000-0005-0000-000200000007"))),
      ...
      botUserViewHandle = Just (Handle {fromHandle = "oihf1d"}),
      botUserViewTeam = Nothing
    }
...
testObject_BotUserView_provider_11 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0006-0000-000400000008"))),
      ...
      botUserViewColour = ColourId {fromColourId = -8},
      botUserViewHandle = Just (Handle {fromHandle = "pe1a"}),
...
testObject_BotUserView_provider_12 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0003-0000-000600000008"))),
      ...
      botUserViewColour = ColourId {fromColourId = 8},
      botUserViewHandle = Just (Handle {fromHandle = "9pbwmf1pu"}),
    ...
    { botUserViewId = (Id (fromJust (UUID.fromString "00000008-0000-0002-0000-000500000000"))),
      ...
      botUserViewHandle =
        Just
          ( Handle
              { fromHandle =
                  "c96fkuf-n70btjq075dki054avcu250987uq348n5bali201abmhiil8n9aiocxhuzuaf1gd733hi-2f7.wtlbb8d30cxymsvmb5ehb_9cu1din7j-996_h1tsvigyg"
              }
          ),
...
testObject_BotUserView_provider_15 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000002-0000-0008-0000-000100000007"))),
      ...
      botUserViewColour = ColourId {fromColourId = -1},
      botUserViewHandle = Just (Handle {fromHandle = "j4z9ty7y-wt_ldl_tddmmrhdfp4myz9fjrqdg2dkh5r9vxcs5z"}),
...
testObject_BotUserView_provider_16 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000006-0000-0007-0000-000800000005"))),
      ...
      botUserViewHandle = Just (Handle {fromHandle = "_mvtpq.f"}),
...
testObject_BotUserView_provider_17 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000003-0000-0000-0000-000400000000"))),
      ...
      botUserViewColour = ColourId {fromColourId = 1},
      botUserViewHandle = Just (Handle {fromHandle = "f.xl"}),
      botUserViewTeam = Nothing
    }
...
testObject_BotUserView_provider_18 =
  BotUserView
    { botUserViewId = (Id (fromJust (UUID.fromString "00000002-0000-0002-0000-000700000000"))),
      ...
      botUserViewColour = ColourId {fromColourId = -7},
      botUserViewHandle = Just (Handle {fromHandle = "b-p"}),
    ...
    { botUserViewId = (Id (fromJust (UUID.fromString "00000005-0000-0007-0000-000200000005"))),
      ...
      botUserViewHandle =
        Just
          ( Handle
              { fromHandle =
                  "g_ms.jaq23mkzzhouss60itfsrux5lapflg0xqotoz76f-ori4aglkqwj-raa_wr4ypirq9c9-w17nwre3414mvmm-vgetkk-07k1dgekjrzcvk-_w33giuc8wcak590c29h457nks5xzpn6tq0wtcorgq7210uaminql8ygrklj3vh11p.sg-nrbnmm2.dxmo0zzhr3xco"
              }
          ),
    ...
    { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0005-0000-000500000003"))),
      ...
      botUserViewHandle =
        Just
          ( Handle
              { fromHandle =
                  "p35n6vhgb5sh71n.-har73f0tp1urvyml_5ni8n01ommlrlx5chb9z7bhp_rehr1geua0--yxs5x3m3dgmvhy8-a-07gbc0owxv2d9mj_pqzss9op.ovxyrid8l36nkw1b5f4sr2.li7bmtmcwe76.zxj9lwbqtqt8v77v6ncnmebtl3whz6790x34rcyqe.jxc6glk2-7d.janj7d1.c70bjkjpzqp0pi64hoiei854tefqdlz246bht"
              }
          ),
