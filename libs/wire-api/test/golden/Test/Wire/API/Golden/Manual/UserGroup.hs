...
testObject_NewUserGroup_1 = NewUserGroup "some name @@~~ii" []

testObject_NewUserGroup_2 :: NewUserGroup
testObject_NewUserGroup_2 = NewUserGroup "some other name @@~~ii" [userId1, userId2]
...
testObject_UserGroup_1 = UserGroup userGroupId1 "name" [] ManagedByWire someUTCTime

testObject_UserGroup_2 :: UserGroup
testObject_UserGroup_2 = UserGroup userGroupId2 "yet another one" [userId1, userId2] ManagedByScim someUTCTime
