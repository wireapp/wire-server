...
tests =
  T.localOption (T.Timeout (60 * 1000000) "60s") . T.testGroup "JSON roundtrip tests" $
    [ testRoundTrip @Asset.AssetToken,
      ...
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureLegalHold),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureSSO),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureSearchVisibility),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureValidateSAMLEmails),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureDigitalSignatures),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureAppLock),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureFileSharing),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureClassifiedDomains),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureConferenceCalling),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithoutPaymentStatus 'Team.Feature.TeamFeatureSelfDeletingMessages),
      testRoundTrip @(Team.Feature.TeamFeatureStatus 'Team.Feature.WithPaymentStatus 'Team.Feature.TeamFeatureSelfDeletingMessages),
