...
testObject_ResumableSettings_user_2 = (mkResumableSettings (AssetVolatile) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
...
testObject_ResumableSettings_user_4 = (mkResumableSettings (AssetVolatile) (True) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_5 :: ResumableSettings
testObject_ResumableSettings_user_5 = (mkResumableSettings (AssetVolatile) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_6 :: ResumableSettings
testObject_ResumableSettings_user_6 = (mkResumableSettings (AssetVolatile) (True) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_7 :: ResumableSettings
testObject_ResumableSettings_user_7 = (mkResumableSettings (AssetExpiring) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
...
testObject_ResumableSettings_user_9 = (mkResumableSettings (AssetPersistent) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_10 :: ResumableSettings
testObject_ResumableSettings_user_10 = (mkResumableSettings (AssetEternalInfrequentAccess) (True) (Type {mimeType = MIME.Image "png", mimeParams = []}))
...
testObject_ResumableSettings_user_14 = (mkResumableSettings (AssetEternal) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
...
testObject_ResumableSettings_user_16 = (mkResumableSettings (AssetExpiring) (True) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_17 :: ResumableSettings
testObject_ResumableSettings_user_17 = (mkResumableSettings (AssetVolatile) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_18 :: ResumableSettings
testObject_ResumableSettings_user_18 = (mkResumableSettings (AssetExpiring) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_19 :: ResumableSettings
testObject_ResumableSettings_user_19 = (mkResumableSettings (AssetVolatile) (False) (Type {mimeType = MIME.Image "png", mimeParams = []}))
testObject_ResumableSettings_user_20 :: ResumableSettings
testObject_ResumableSettings_user_20 = (mkResumableSettings (AssetEternal) (True) (Type {mimeType = MIME.Image "png", mimeParams = []}))
