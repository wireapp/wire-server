...
testObject_Client_user_19 = Client {clientId = ClientId {client = "2"}, clientType = PermanentClientType, clientTime = (fromJust (readUTCTimeMillis "1864-05-12T07:49:27.999Z")), clientClass = Just DesktopClient, clientLabel = Just "\1098224l", clientCookie = Nothing, clientLocation = Just (location (Latitude (-1.4630309786758076)) (Longitude (-0.5295690632216867))), clientModel = Just "", clientCapabilities = ClientCapabilityList []}

testObject_Client_user_20 :: Client
testObject_Client_user_20 = Client {clientId = ClientId {client = "1"}, clientType = LegalHoldClientType, clientTime = (fromJust (readUTCTimeMillis "1864-05-06T18:43:52.483Z")), clientClass = Just PhoneClient, clientLabel = Just "-\1032867v", clientCookie = Just (CookieLabel {cookieLabelText = ""}), clientLocation = Just (location (Latitude (2.8672347564452996)) (Longitude (-0.9990390825956594))), clientModel = Nothing, clientCapabilities = ClientCapabilityList []}
