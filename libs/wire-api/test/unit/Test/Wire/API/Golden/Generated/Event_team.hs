...
testObject_Event_team_14 = (newEvent (ConvDelete) ((Id (fromJust (UUID.fromString "00006c11-0000-76d2-0000-09da000047d8")))) (read ("1864-05-02 18:02:02.563349061703 UTC")) & eventData .~ (Just (EdConvDelete (Id (fromJust (UUID.fromString "000071e4-0000-24dd-0000-41dd000013e5"))))))

testObject_Event_team_15 :: Event
testObject_Event_team_15 = (newEvent (ConvDelete) ((Id (fromJust (UUID.fromString "00007fe4-0000-5f5d-0000-140500001c24")))) (read ("1864-06-04 00:19:07.663093674023 UTC")) & eventData .~ (Just (EdConvDelete (Id (fromJust (UUID.fromString "000074e6-0000-1d53-0000-7d6400001363"))))))

testObject_Event_team_16 :: Event
testObject_Event_team_16 = (newEvent (ConvDelete) ((Id (fromJust (UUID.fromString "00000ea7-0000-0ab2-0000-36120000290d")))) (read ("1864-04-23 09:55:44.855155072596 UTC")) & eventData .~ (Just (EdConvDelete (Id (fromJust (UUID.fromString "00007c20-0000-6564-0000-046c00004725"))))))

testObject_Event_team_17 :: Event
testObject_Event_team_17 = (newEvent (ConvCreate) ((Id (fromJust (UUID.fromString "00006611-0000-7382-0000-5ca500006e9f")))) (read ("1864-05-26 12:52:34.967254218092 UTC")) & eventData .~ (Just (EdConvCreate (Id (fromJust (UUID.fromString "0000713e-0000-6f9d-0000-40e2000036e7"))))))

testObject_Event_team_18 :: Event
testObject_Event_team_18 = (newEvent (MemberUpdate) ((Id (fromJust (UUID.fromString "00001705-0000-202b-0000-578a000056d0")))) (read ("1864-05-05 05:53:46.446463823554 UTC")) & eventData .~ (Just (EdMemberUpdate (Id (fromJust (UUID.fromString "00007783-0000-7d60-0000-00d30000396e"))) (Just (Permissions {_self = fromList [CreateConversation, DoNotUseDeprecatedDeleteConversation, AddTeamMember, RemoveTeamMember, DoNotUseDeprecatedAddRemoveConvMember, DoNotUseDeprecatedModifyConvName, GetBilling, SetBilling, SetTeamData, GetMemberPermissions, SetMemberPermissions, GetTeamConversations, DeleteTeam], _copy = fromList [CreateConversation, DoNotUseDeprecatedDeleteConversation, AddTeamMember, RemoveTeamMember, DoNotUseDeprecatedAddRemoveConvMember, DoNotUseDeprecatedModifyConvName, GetBilling, GetMemberPermissions, SetMemberPermissions, DeleteTeam]})))))

testObject_Event_team_19 :: Event
testObject_Event_team_19 = (newEvent (MemberUpdate) ((Id (fromJust (UUID.fromString "00004e8a-0000-7afa-0000-61ad00000f71")))) (read ("1864-05-28 17:18:44.856809552438 UTC")) & eventData .~ (Just (EdMemberUpdate (Id (fromJust (UUID.fromString "0000382c-0000-1ce7-0000-568b00001fe9"))) (Just (Permissions {_self = fromList [DoNotUseDeprecatedDeleteConversation, RemoveTeamMember, DoNotUseDeprecatedAddRemoveConvMember, DoNotUseDeprecatedModifyConvName, GetBilling, SetBilling, GetMemberPermissions, GetTeamConversations], _copy = fromList [DoNotUseDeprecatedDeleteConversation, RemoveTeamMember, DoNotUseDeprecatedAddRemoveConvMember, GetBilling, SetBilling, GetMemberPermissions, GetTeamConversations]})))))

testObject_Event_team_20 :: Event
testObject_Event_team_20 = (newEvent (TeamDelete) ((Id (fromJust (UUID.fromString "00001872-0000-568f-0000-2ad400004faf")))) (read ("1864-06-02 05:36:57.222646120353 UTC")) & eventData .~ (Nothing))
