...
testObject_UserConnection_user_1 = UserConnection {ucFrom = (Id (fromJust (UUID.fromString "00000000-0000-0004-0000-000100000001"))), ucTo = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000300000002"))), ucStatus = Pending, ucLastUpdate = (fromJust (readUTCTimeMillis "1864-05-07T21:52:21.955Z")), ucMessage = Nothing, ucConvId = Nothing}
