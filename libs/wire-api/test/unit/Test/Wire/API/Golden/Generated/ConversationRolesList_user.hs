...
testObject_ConversationRolesList_user_11 = ConversationRolesList {convRolesList = [(fromJust (toConvRole (fromJust (parseRoleName "bnsi81m0tcsgtrah39sunugjnf5cv4qe9cy2_4084vghyzey6giq6ttpkqms2je")) (Just ((Actions (Set.fromList [AddConversationMember, RemoveConversationMember, ModifyConversationName, ModifyConversationAccess, ModifyOtherConversationMember, LeaveConversation, DeleteConversation]))))))]}
...
testObject_ConversationRolesList_user_15 = ConversationRolesList {convRolesList = [(fromJust (toConvRole (fromJust (parseRoleName "bxb790gxo1o8dh99kofgn0m463fg_nupp5_rmlzn_ikitu8un98x3teiybvx7srcqejb2dx")) (Just ((Actions (Set.fromList [])))))), (fromJust (toConvRole (fromJust (parseRoleName "wire_member")) Nothing)), (fromJust (toConvRole (fromJust (parseRoleName "wire_admin")) Nothing)), (fromJust (toConvRole (fromJust (parseRoleName "wire_admin")) Nothing)), (fromJust (toConvRole (fromJust (parseRoleName "wire_member")) Nothing)), (fromJust (toConvRole (fromJust (parseRoleName "wire_member")) Nothing)), (fromJust (toConvRole (fromJust (parseRoleName "vtkdq7dc620aog28hmkxr7j8n2_3xib0dxpgv28d8ypqn_nf61utf69v9t2dy6kepnd_1")) (Just ((Actions (Set.fromList [ModifyOtherConversationMember]))))))]}
