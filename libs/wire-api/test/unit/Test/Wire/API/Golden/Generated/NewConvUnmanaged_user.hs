...
testObject_NewConvUnmanaged_user_15 = NewConvUnmanaged (NewConv {newConvUsers = [(Id (fromJust (UUID.fromString "00000002-0000-0003-0000-000300000003")))], newConvName = Just "b\1008988", newConvAccess = Set.fromList [PrivateAccess, InviteAccess, CodeAccess], newConvAccessRole = Nothing, newConvTeam = Just (ConvTeamInfo {cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000200000002"))), cnvManaged = False}), newConvMessageTimer = Just (Ms {ms = 4005602882980532}), newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 1}), newConvUsersRole = (fromJust (parseRoleName "_wje4g3_kcquzyoms0q4cwzz8"))})

testObject_NewConvUnmanaged_user_16 :: NewConvUnmanaged
testObject_NewConvUnmanaged_user_16 = NewConvUnmanaged (NewConv {newConvUsers = [], newConvName = Just "!", newConvAccess = Set.fromList [PrivateAccess, CodeAccess], newConvAccessRole = Just PrivateAccessRole, newConvTeam = Just (ConvTeamInfo {cnvTeamId = (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000100000000"))), cnvManaged = False}), newConvMessageTimer = Nothing, newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 1}), newConvUsersRole = (fromJust (parseRoleName "04ukg5i2nomsgwiphznmsrk1ou3ukxemisi9g"))})
...
testObject_NewConvUnmanaged_user_19 = NewConvUnmanaged (NewConv {newConvUsers = [(Id (fromJust (UUID.fromString "00000002-0000-0001-0000-000000000002")))], newConvName = Just "Cu\DC1", newConvAccess = Set.fromList [InviteAccess, LinkAccess], newConvAccessRole = Nothing, newConvTeam = Nothing, newConvMessageTimer = Just (Ms {ms = 864918593306344}), newConvReceiptMode = Just (ReceiptMode {unReceiptMode = -1}), newConvUsersRole = (fromJust (parseRoleName "xik7vc3wp82gw4r934rad_bhmf2orany3qgu_tx9huwfrlxy8m0id71x20uddebps30zdahe_ffcxxhc"))})

testObject_NewConvUnmanaged_user_20 :: NewConvUnmanaged
testObject_NewConvUnmanaged_user_20 = NewConvUnmanaged (NewConv {newConvUsers = [], newConvName = Just "\SI\1070774", newConvAccess = Set.fromList [PrivateAccess], newConvAccessRole = Nothing, newConvTeam = Nothing, newConvMessageTimer = Just (Ms {ms = 3641984282941906}), newConvReceiptMode = Just (ReceiptMode {unReceiptMode = -1}), newConvUsersRole = (fromJust (parseRoleName "udhi2sbf7tzyshrh"))})
