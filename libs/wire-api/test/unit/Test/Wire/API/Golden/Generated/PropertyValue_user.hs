...
testObject_PropertyValue_user_2 =
  PropertyValue
    { propertyValueJson =
        Object
          ( fromList
              [ ("M\ETX\ENQ\af\176612\n\155245|n", String "\178208\bwS"),
                ("\17080Z%\1025245\DELrgT^", Number (-100.0)),
                ("fgH", Bool False)
              ]
          )
    }
...
testObject_PropertyValue_user_3 =
  PropertyValue
    { propertyValueJson = Object (fromList [("", Number (7.0e-5)), ("/\vT", Bool True), ("^}Y{Nt", Bool False)])
    }

testObject_PropertyValue_user_4 :: PropertyValue
testObject_PropertyValue_user_4 =
  PropertyValue
    { propertyValueJson =
        Array
          [ Null,
...
testObject_PropertyValue_user_7 =
  PropertyValue
    { propertyValueJson =
        Object
          ( fromList
              [ ("", Number (1.0e-5)),
                ("\STXy", Null),
                ("r\1035660\"TD", String "\54670"),
                ("\f]X", Number (2.0e-5)),
                ("f\DC2\1059734", Number (1.0e-2)),
                ("\987855", String "\997146\RS\CANu\n")
              ]
          )
    }
...
testObject_PropertyValue_user_9 =
  PropertyValue
    { propertyValueJson =
        Array
          [ Bool True,
...
testObject_PropertyValue_user_11 =
  PropertyValue
    { propertyValueJson =
        Object
          ( fromList
              [ ("0", Number (-4.0e7)),
                ("\873", Bool False),
                ("\1048918\71091\133971Q3\SOH\"", Null),
                ("\1089049n", Bool False)
              ]
          )
    }
...
testObject_PropertyValue_user_12 =
  PropertyValue
    { propertyValueJson =
        Array
          [ Bool True,
...
testObject_PropertyValue_user_13 =
  PropertyValue
    { propertyValueJson = Array [Null, Bool False, String "*\SOHO", Number (0.1), String "\SOp\12293\1075098"]
    }
...
testObject_PropertyValue_user_15 =
  PropertyValue
    { propertyValueJson =
        Object
          ( fromList
...
testObject_PropertyValue_user_17 =
  PropertyValue {propertyValueJson = Array [Number (100.0), Bool False, String "#\\\993660`r\1110635"]}

testObject_PropertyValue_user_18 :: PropertyValue
testObject_PropertyValue_user_18 =
  PropertyValue
    { propertyValueJson =
        Object
          ( fromList
              [ ("\1078290\SOHeD\991615", Number (3.0e-5)),
                (")\ESCt\10112", Number (-4.0e-3)),
                ("\60512%9", Bool False),
                ("", Number (0.1)),
                ("\DC3", Number (400.0)),
                ("{ *f~", Number (-400.0))
...
testObject_PropertyValue_user_19 =
  PropertyValue
    { propertyValueJson =
        Array
          [ Null,
