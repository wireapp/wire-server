...
testObject_PasswordResetCode_user_9 = PasswordResetCode {fromPasswordResetCode = (fromRight undefined (validate ("RAxVH7Nx9wLrjYlmhoz37XNTNzJ-BZ0Wqgr0K7JM_B8U5YEk5o6fGcjmPxSzQWBsEMFASQx=ZfUg4HGHHlYPln8ar_v4AiudJxC2L_vHb72_gpGNpMTqXPVf_")))}
...
testObject_PasswordResetCode_user_19 = PasswordResetCode {fromPasswordResetCode = (fromRight undefined (validate ("6rfuE95RuDaa7Kx3neuvC_Zb81Xe5ADzRP6QwHfon6Q5aiFtXUquRy3kl5E4P48UVPH5gIPkBNb_BskNUfiSYCfItGCOAIoiLITSJOX3rN2uTFTzDhW3QO2zjvFMSlgmT_Ew2rcCt")))}

testObject_PasswordResetCode_user_20 :: PasswordResetCode
testObject_PasswordResetCode_user_20 = PasswordResetCode {fromPasswordResetCode = (fromRight undefined (validate ("i_v2THLu-oaTQDdbBLhfcTJrCPRiyGC=p40dGNfFMRJAJuLbv=RasCBzDYpTNkb7yIZMge1Uijc5KG3pWHAoavVJWJ9VtE-Pkf3Te-P1hp")))}
