...
testObject_MemberUpdate_user_3 =
  MemberUpdate
    { mupOtrMute = Just True,
      ...
      mupHiddenRef = Just "",
      mupConvRoleName =
        Just (fromJust (parseRoleName "29pgeoc1x6764fsdwtticdvz1bvso_q95d5673zo7s076hshdzoa7ufh55os_8eedfy3r8e"))
    }
    ...
    { mupOtrMute = Just True,
      ...
      mupConvRoleName =
        Just
          ( fromJust
              ( parseRoleName
                  "y3f2wfk4s6odkp67ngv2dqsymq12ru1f6yiar17kpyoi0ng0yu7bqzr4_1c8jsr6zdaw24xs47bdq5um3vc501nr3s89kn0dhe9c5k52pzfzfws3"
              )
          )
    }
...
testObject_MemberUpdate_user_5 =
  MemberUpdate
    { mupOtrMute = Nothing,
      ...
      mupOtrMuteRef = Nothing,
      mupOtrArchive = Just False,
      mupOtrArchiveRef = Just "\EOT\37502",
      mupHidden = Just False,
      mupHiddenRef = Just "\\",
...
testObject_MemberUpdate_user_6 =
  MemberUpdate
    { mupOtrMute = Just True,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Nothing,
      ...
      mupOtrArchiveRef = Just "",
      mupHidden = Nothing,
      mupHiddenRef = Just "\110670\2236*",
      mupConvRoleName =
        Just (fromJust (parseRoleName "_loalxj_i6vbh4aebdkbyr59_hawtw3fzjeffcw8llqvhdjx9k6cq3fzsk78zpejqy2om6"))
    }
...
testObject_MemberUpdate_user_7 =
  MemberUpdate
    { mupOtrMute = Nothing,
      ...
      mupHidden = Just True,
      mupHiddenRef = Nothing,
      mupConvRoleName = Just (fromJust (parseRoleName "5la_7_6jn396azj61gyopd1z6dkqfkd56kerwmng27x1"))
    }
...
testObject_MemberUpdate_user_8 =
  MemberUpdate
    { mupOtrMute = Just True,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "m",
      mupOtrArchive = Just True,
      mupOtrArchiveRef = Nothing,
      mupHidden = Just True,
      mupHiddenRef = Just "\5167",
      mupConvRoleName = Nothing
    }

testObject_MemberUpdate_user_9 :: MemberUpdate
testObject_MemberUpdate_user_9 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "8\16235Q",
      mupOtrArchive = Just False,
      mupOtrArchiveRef = Nothing,
      mupHidden = Just True,
      mupHiddenRef = Just "\CANan",
      mupConvRoleName =
        Just (fromJust (parseRoleName "_sg5ujt7r_74lesoq1b__dsmy_ewiryj0ak_6y1mlwf5okqxx7hx9sr7q2hqq0g9xj6bx1144z4mk7"))
    }
...
testObject_MemberUpdate_user_10 =
  MemberUpdate
    { mupOtrMute = Nothing,
      ...
      mupOtrMuteRef = Just "",
      mupOtrArchive = Just False,
      mupOtrArchiveRef = Just "\SOH",
      mupHidden = Just True,
      mupHiddenRef = Just "",
      mupConvRoleName = Just (fromJust (parseRoleName "r6pd3cc"))
    }
...
testObject_MemberUpdate_user_11 =
  MemberUpdate
    { mupOtrMute = Just False,
      ...
      mupOtrArchiveRef = Just "",
      mupHidden = Nothing,
      mupHiddenRef = Just "%nc",
      mupConvRoleName = Just (fromJust (parseRoleName "d1pquul8mcpzzyd"))
    }

testObject_MemberUpdate_user_12 :: MemberUpdate
testObject_MemberUpdate_user_12 =
  MemberUpdate
    { mupOtrMute = Nothing,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "N",
      mupOtrArchive = Just True,
      mupOtrArchiveRef = Nothing,
      mupHidden = Just True,
      mupHiddenRef = Nothing,
      mupConvRoleName = Just (fromJust (parseRoleName "uwira8"))
    }

testObject_MemberUpdate_user_13 :: MemberUpdate
testObject_MemberUpdate_user_13 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just ",\136190x",
      mupOtrArchive = Nothing,
      mupOtrArchiveRef = Nothing,
      mupHidden = Nothing,
      mupHiddenRef = Just " \98741",
      mupConvRoleName =
        Just (fromJust (parseRoleName "8_gp4dnllqkywu8ynwrefdulehdg2tj5a_tuug8pzdbxjmwbzrj4hbmzv74626xwgnvan"))
    }

testObject_MemberUpdate_user_14 :: MemberUpdate
testObject_MemberUpdate_user_14 =
  MemberUpdate
    { mupOtrMute = Nothing,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Nothing,
...
testObject_MemberUpdate_user_15 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "\54053f\152356",
      mupOtrArchive = Just True,
      mupOtrArchiveRef = Just "\998566",
      mupHidden = Just True,
      mupHiddenRef = Just "4\ETX\1061048",
      mupConvRoleName = Just (fromJust (parseRoleName "u19bhfqrug1dc7e98hjpfv3d0"))
    }
...
testObject_MemberUpdate_user_16 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "pa/",
      mupOtrArchive = Just False,
      mupOtrArchiveRef = Just "",
      mupHidden = Just False,
      mupHiddenRef = Just "",
      mupConvRoleName = Just (fromJust (parseRoleName "8emml6p8nqqdn61rankt2i2_5mhk3y3baf_bon8v50q"))
    }

testObject_MemberUpdate_user_17 :: MemberUpdate
testObject_MemberUpdate_user_17 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Nothing,
      ...
      mupOtrArchiveRef = Nothing,
      mupHidden = Just False,
      mupHiddenRef = Just "5\20987[",
      mupConvRoleName = Just (fromJust (parseRoleName "lvnn0dbt1o_5lp7f"))
    }

testObject_MemberUpdate_user_18 :: MemberUpdate
testObject_MemberUpdate_user_18 =
  MemberUpdate
    { mupOtrMute = Nothing,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Nothing,
...
testObject_MemberUpdate_user_19 =
  MemberUpdate
    { mupOtrMute = Just False,
      mupOtrMuteStatus = Nothing,
      mupOtrMuteRef = Just "\DC4]\ENQ",
      mupOtrArchive = Just True,
      mupOtrArchiveRef = Just "(\ETX2",
      mupHidden = Just False,
      mupHiddenRef = Nothing,
      mupConvRoleName = Just (fromJust (parseRoleName "kpe3j2ccnryh3awf1gx2sqyxzrihjb4nikgfdmphg9r5gxdl97l1q6a4b5c"))
    }
...
testObject_MemberUpdate_user_20 =
  MemberUpdate
    { mupOtrMute = Nothing,
      ...
      mupOtrMuteRef = Just "",
      mupOtrArchive = Just False,
      mupOtrArchiveRef = Just "Z(\1091997",
      mupHidden = Just True,
      mupHiddenRef = Nothing,
      mupConvRoleName = Just (fromJust (parseRoleName "9v_lqtkfm4ohgvnqdj5qyua7hn8l7gcwy05"))
    }
