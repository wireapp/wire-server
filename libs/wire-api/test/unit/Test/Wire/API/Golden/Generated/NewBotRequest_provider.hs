          ...
          { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000100000000"))),
            ...
            botUserViewHandle =
              Just
                ( Handle
                    { fromHandle =
                        "h.cn77ac0vrssl3li_xktkmwmps_8s6y-ntsnv5e6i6pc4tihqh6t9paxuyxopod76mgse-4pyop9v.n6uhz5"
                    }
                ),
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000000"))),
            ...
            botUserViewColour = ColourId {fromColourId = -1},
            botUserViewHandle =
              Just (Handle {fromHandle = "dcd5u---q-5liar3qaixbwwjjrg-79a2k413z74whfyc-k_8jvle63fhs3v.mdncia29"}),
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000000000001"))),
            ...
            botUserViewColour = ColourId {fromColourId = 1},
            botUserViewHandle = Just (Handle {fromHandle = "chuc8zlscl1gioct"}),
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000000000001"))),
            ...
            botUserViewColour = ColourId {fromColourId = 1},
            botUserViewHandle = Just (Handle {fromHandle = "hy4dc"}),
            botUserViewTeam = Nothing
          },
      newBotConv =
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000100000000"))),
            ...
            botUserViewColour = ColourId {fromColourId = -1},
            botUserViewHandle = Just (Handle {fromHandle = "pt-g.o"}),
          ...
          { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000001"))),
            ...
            botUserViewHandle =
              Just
                ( Handle
                    { fromHandle =
                        "2mbu57j9i5av3tl5qq3defu9ydjatm7y-bgi4nznqyvcbmdn66pma5ice6famcazb892aqtzz2_zclckldrjh6nq69sz_2p0qx99p6t2ogt9ewzzq2olgge32jyt6kmwgmzvdbeti-iygnitchblkicol8m83a8n-a2ip-yy27z2llzu7"
                    }
                ),
          ...
          { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000100000001"))),
            ...
            botUserViewHandle =
              Just
                ( Handle
                    { fromHandle =
                        "7g_a0on27rzpz7cfzl3hle6v7dwv.db.to.ief5xzr3eu.vr5jb57_z5t3ahmggm9oddsd-quxc1uv4xkr7ncg9ff9zicgsjenafoxe4jbtrzjagqy84xrvt7iv_dcpe7_iiyg3tpeg8fh2osxf7dv01ueygahrdokoa-2ya37r6g0b0u3j416qnnk.404lffdz"
                    }
                ),
            botUserViewTeam = Just (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000100000001")))
          },
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000000"))),
            ...
            botUserViewColour = ColourId {fromColourId = -1},
            botUserViewHandle = Just (Handle {fromHandle = "ho"}),
            botUserViewTeam = Just (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000000000000")))
          },
      newBotConv =
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000000000000"))),
            ...
            botUserViewColour = ColourId {fromColourId = 1},
            botUserViewHandle = Just (Handle {fromHandle = "o8opul3h"}),
            botUserViewTeam = Just (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000100000001")))
          },
      newBotConv =
      ...
      newBotOrigin =
        BotUserView
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000100000000"))),
            ...
            botUserViewColour = ColourId {fromColourId = 0},
            botUserViewHandle = Just (Handle {fromHandle = "gcmc3fjd3ire.maquq87awi"}),
            botUserViewTeam = Nothing
          },
      newBotConv =
        ( botConvView
          ...
          { botUserViewId = (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000100000001"))),
            ...
            botUserViewHandle =
              Just
                ( Handle
                    { fromHandle =
                        "th4n3ndvnpp49es-gz55m5nnya_d.mcna7zg2t-t.xhcz6xbh17cg0.trdfgmo8whrtkl9fqdi8jg7d3nlh03p.bpumzn-.89h4.i75x6gx.x7kos0x4hqc.31hy78ckr6502kun7u7_b1a.8mw3oo3ylv.k29_zei793az7xlfaes1wa2gvu4tad52v5-w8rz9o-ivftxq5-nz87uhlm"
                    }
                ),
            botUserViewTeam = Just (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000000000001")))
          },
