...
testObject_ConversationRole_user_4 =
  ( fromJust
      ( toConvRole
...
testObject_ConversationRole_user_11 =
  ( fromJust
      ( toConvRole
          ( fromJust
              ( parseRoleName
...
testObject_ConversationRole_user_19 =
  ( fromJust
      ( toConvRole
          (fromJust (parseRoleName "idsg79l46dbcc6qqm12fucmnni7fe4xf6x_rnushx6gojdlgu5"))
          (Just ((Actions (Set.fromList [AddConversationMember, ModifyConversationAccess]))))
      )
  )
