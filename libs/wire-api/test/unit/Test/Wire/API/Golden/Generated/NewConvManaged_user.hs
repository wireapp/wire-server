    ...
    ( NewConv
        { newConvUsers = [(Id (fromJust (UUID.fromString "00000002-0000-0001-0000-000400000000")))],
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000002-0000-0002-0000-000200000002"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 5509522199847054}),
          newConvReceiptMode = Nothing,
          newConvUsersRole = (fromJust (parseRoleName "bewzponl1a3c_l6ou"))
        }
    )

testObject_NewConvManaged_user_3 :: NewConvManaged
testObject_NewConvManaged_user_3 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000000"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 582808797322573}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 2}),
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "kbqqptmp0tna583vobrgtadyismkkpnjdwsef9jlgvezy00yu5u2rds0ng11vppapcn9n7enwrg7tkwxvg1mz_rh7pcoi_btpcyg5akueydofop60j"
                )
            )
        }
    )
    ...
    ( NewConv
        { newConvUsers =
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000100000002"))),
                    cnvManaged = True
                  }
              ),
          ...
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "pa5z_izggck3l0sn9qc_yx06bwh_k1vf2drs3c8w35wyqwl3tco54d7lvnbh3udjzs8avs0j1dxr7v40ldpqgy4lszpnxx3f0hpy_37ofx30s9oa9t"
                )
            )
        }
    )
...
testObject_NewConvManaged_user_5 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000100000000"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 1570858821505994}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = -1}),
          newConvUsersRole = (fromJust (parseRoleName "mqkbqyi796z05v6jj4ijc7nl5unid6eq1t028pp9awv2_8bc61wq0zl"))
        }
    )

testObject_NewConvManaged_user_6 :: NewConvManaged
testObject_NewConvManaged_user_6 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvMessageTimer = Just (Ms {ms = 6614365418177275}),
          newConvReceiptMode = Nothing,
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "gf5j3kqv7_6g55q6clu47jn2iq5yy_zvnm2753m2llu04bhb5ct_v53u7kmwdesgs832yylb_v5eddllgbostkjj7qwv7"
                )
            )
        }
    )
  ...
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvMessageTimer = Just (Ms {ms = 7417375067718994}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 0}),
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "ce4ylezzp_1s9b3xbw7akybntwbaa21p8ijqsk53ymljzx_kubjl4tjvrdwb8jjm21cznytrtaffnemverdd39vqvbfxn_pl_"
                )
            )
        }
    )
    ...
    ( NewConv
        { newConvUsers =
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000100000001"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Nothing,
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 2}),
          newConvUsersRole = (fromJust (parseRoleName "ms6f79wv82ftbu608wl9jeu8xatyhb1p1ck5t9yht9xqjcldet9kj6gp4b"))
        }
    )
    ...
    ( NewConv
        { newConvUsers = [],
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000000"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 2550845209410146}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 1}),
          newConvUsersRole = (fromJust (parseRoleName "yd"))
        }
    )

testObject_NewConvManaged_user_10 :: NewConvManaged
testObject_NewConvManaged_user_10 =
  NewConvManaged
    ( NewConv
        { newConvUsers = [(Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000100000001")))],
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000001"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 8061252799624904}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 1}),
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "vakyrex99a9vi36iemc7wj4gu39s4wf30c2r_mqatgyer4y4dzypd_y7x3i9embufwc6e4nfuqvuvu9p72r8xdnmho615wrlkcr1h4e8tnokdio9t"
                )
            )
        }
    )
    ...
    ( NewConv
        { newConvUsers = [],
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000200000001"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 6292627004994884}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = -2}),
          newConvUsersRole = (fromJust (parseRoleName "z5r2jhv40n91iwidhdui7jaa6i"))
        }
    )

testObject_NewConvManaged_user_12 :: NewConvManaged
testObject_NewConvManaged_user_12 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
            [ (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000001"))),
          ...
          newConvMessageTimer = Just (Ms {ms = 7043412511612101}),
          newConvReceiptMode = Nothing,
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "4ek91n56al0j6mc3ovtreftmizb2qoh05m_zozgr6ar1vorbh2gdx3b72gm_q65h815zuy_2qehwf9t20l3mabd53813168ccg"
                )
            )
        }
    )
...
testObject_NewConvManaged_user_13 =
  NewConvManaged
    ( NewConv
        { newConvUsers = [],
          newConvQualifiedUsers = [],
          ...
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "220zl1nunhfwpvjm85iz_ixp98rq1dlwnqp7s18efvnonl6skfzkqvkxanemogf7ok3q29y5jzd4prt6s6ybl0ko47iu_zux5x7"
                )
            )
        }
    )
...
testObject_NewConvManaged_user_14 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
            [ (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000001"))),
          ...
          newConvMessageTimer = Just (Ms {ms = 8669416711689656}),
          newConvReceiptMode = Nothing,
          newConvUsersRole = (fromJust (parseRoleName "d1t6fg7c_ksqcoe6e308n2xblhwg8m7ahrnia88at1"))
        }
    )
  ...
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvMessageTimer = Just (Ms {ms = 1166285470102499}),
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = 2}),
          newConvUsersRole = (fromJust (parseRoleName "5uxmr3gdwwipozxh"))
        }
    )
    ...
    ( NewConv
        { newConvUsers = [],
          ...
          newConvTeam =
            Just
              ( ConvTeamInfo
                  { cnvTeamId = (Id (fromJust (UUID.fromString "00000002-0000-0001-0000-000000000001"))),
                    cnvManaged = True
                  }
              ),
          newConvMessageTimer = Just (Ms {ms = 4425819976591162}),
          newConvReceiptMode = Nothing,
          newConvUsersRole =
            ( fromJust
                ( parseRoleName
                    "dc5k1w34ghjhorv48fy8f3_ya4n8sq1vrr7oojpht2_tbfviuu9i43aaxgpce744vxs6ikex7q35mv17svnwotre29fm"
                )
            )
        }
    )
  ...
  NewConvManaged
    ( NewConv
        { newConvUsers =
          ...
          newConvMessageTimer = Just (Ms {ms = 5065871950676797}),
          newConvReceiptMode = Nothing,
          newConvUsersRole = (fromJust (parseRoleName "faa_2g09yehf26736w2p59cuw_giwelkq2d_y4q5sj49n9"))
        }
    )

testObject_NewConvManaged_user_18 :: NewConvManaged
testObject_NewConvManaged_user_18 =
  NewConvManaged
    ( NewConv
        { newConvUsers = [],
          newConvQualifiedUsers = [],
          ...
          newConvMessageTimer = Nothing,
          newConvReceiptMode = Just (ReceiptMode {unReceiptMode = -1}),
          newConvUsersRole = (fromJust (parseRoleName "e9_exzeqnr163dd14s7van73vd_9lth079onlldtkmk"))
        }
    )
  ...
  NewConvManaged
    ( NewConv
        { newConvUsers = [(Id (fromJust (UUID.fromString "00000003-0000-0004-0000-000400000002")))],
          ...
          newConvMessageTimer = Just (Ms {ms = 8428756728484885}),
          newConvReceiptMode = Nothing,
          newConvUsersRole =
            (fromJust (parseRoleName "x2g84s2bn8uq_i6yizofg4xx9yvbseuw53u8oafwx5cwn26i5xl2ojio90cwv2kz0pl9p6hfrogrp"))
        }
    )

testObject_NewConvManaged_user_20 :: NewConvManaged
testObject_NewConvManaged_user_20 =
  NewConvManaged
    ( NewConv
        { newConvUsers =
            [ (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000100000001"))),
          ...
          newConvMessageTimer = Just (Ms {ms = 6168723896440273}),
          newConvReceiptMode = Nothing,
          newConvUsersRole = (fromJust (parseRoleName "url0_7h6wig8d_ro8fwdmuqggbynbdkjshlg_ei8qqu"))
        }
    )
