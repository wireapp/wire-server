...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_2 =
  ConversationList
    { convList =
        [ (Id (fromJust (UUID.fromString "00000000-0000-0004-0000-000700000004"))),
          (Id (fromJust (UUID.fromString "00000000-0000-0006-0000-000600000001")))
        ],
      convHasMore = False
    }

testObject_ConversationList_20_28Id_20_2a_20C_29_user_3 :: ConversationList (ConvId)
testObject_ConversationList_20_28Id_20_2a_20C_29_user_3 =
  ConversationList
    { convList =
...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_7 =
  ConversationList
    { convList = [(Id (fromJust (UUID.fromString "00000003-0000-0024-0000-005000000011")))],
      convHasMore = False
    }

testObject_ConversationList_20_28Id_20_2a_20C_29_user_8 :: ConversationList (ConvId)
testObject_ConversationList_20_28Id_20_2a_20C_29_user_8 =
  ConversationList
    { convList = [(Id (fromJust (UUID.fromString "00000056-0000-0072-0000-00160000007a")))],
      convHasMore = True
    }

testObject_ConversationList_20_28Id_20_2a_20C_29_user_9 :: ConversationList (ConvId)
testObject_ConversationList_20_28Id_20_2a_20C_29_user_9 =
  ConversationList
    { convList =
        [ (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000100000000"))),
          ...
          (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000001"))),
          (Id (fromJust (UUID.fromString "00000002-0000-0002-0000-000100000000"))),
...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_11 =
  ConversationList
    { convList =
        [ (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000100000001"))),
          (Id (fromJust (UUID.fromString "00000002-0000-0001-0000-000400000003"))),
...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_12 =
  ConversationList
    { convList =
...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_17 =
  ConversationList
    { convList = [(Id (fromJust (UUID.fromString "0000006d-0000-0005-0000-00150000005f")))],
      convHasMore = False
    }
...
testObject_ConversationList_20_28Id_20_2a_20C_29_user_19 =
  ConversationList
    { convList = [(Id (fromJust (UUID.fromString "0000003a-0000-002f-0000-00300000001b")))],
      convHasMore = False
    }
