...
module Test.Wire.API.Golden.FromJSON.NewOtrMessage where
...
-- | Tests these defaults while parsing JSON
-- native_push: True
-- transient: False
fromJSON_testObject_NewOtrMessage_1 :: NewOtrMessage
fromJSON_testObject_NewOtrMessage_1 =
  NewOtrMessage
