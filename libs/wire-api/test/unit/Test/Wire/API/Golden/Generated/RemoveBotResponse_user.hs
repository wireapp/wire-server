...
testObject_RemoveBotResponse_user_2 = RemoveBotResponse {rsRemoveBotEvent = (Event (ConvDelete) ((Id (fromJust (UUID.fromString "00005a06-0000-10ab-0000-4999000058de")))) ((Id (fromJust (UUID.fromString "00004247-0000-0560-0000-07df00005850")))) (read "1864-04-23 16:56:18.982 UTC") (Nothing))}
...
testObject_RemoveBotResponse_user_10 = RemoveBotResponse {rsRemoveBotEvent = (Event (Typing) ((Id (fromJust (UUID.fromString "00005788-0000-327b-0000-7ef80000017e")))) ((Id (fromJust (UUID.fromString "0000588d-0000-6704-0000-153f00001692")))) (read "1864-04-11 02:49:27.442 UTC") (Just (EdTyping (TypingData {tdStatus = StartedTyping}))))}
...
testObject_RemoveBotResponse_user_19 = RemoveBotResponse {rsRemoveBotEvent = (Event (ConvCodeDelete) ((Id (fromJust (UUID.fromString "00000c59-0000-51c7-0000-1b6500001384")))) ((Id (fromJust (UUID.fromString "00003046-0000-14df-0000-5a5900005ef2")))) (read "1864-04-19 14:51:39.037 UTC") (Nothing))}

testObject_RemoveBotResponse_user_20 :: RemoveBotResponse
testObject_RemoveBotResponse_user_20 = RemoveBotResponse {rsRemoveBotEvent = (Event (ConvMessageTimerUpdate) ((Id (fromJust (UUID.fromString "00004e98-0000-2ec5-0000-31870000098c")))) ((Id (fromJust (UUID.fromString "00006cb0-0000-6547-0000-1fe500000270")))) (read "1864-05-18 03:54:11.412 UTC") (Just (EdConvMessageTimerUpdate (ConversationMessageTimerUpdate {cupMessageTimer = Just (Ms {ms = 5776200192005000})}))))}
