    ...
    { rsRemoveBotEvent =
        ( Event
            ...
            ( ( EdMembersLeave
                  ( UserIdList
                      { mUsers =
                          [ (Id (fromJust (UUID.fromString "000038c1-0000-4a9c-0000-511300004c8b"))),
                            (Id (fromJust (UUID.fromString "00003111-0000-2620-0000-1c8800000ea0"))),
                            (Id (fromJust (UUID.fromString "00000de2-0000-6a83-0000-094b00007b02"))),
                            (Id (fromJust (UUID.fromString "00001203-0000-7200-0000-7f8600001824"))),
                            (Id (fromJust (UUID.fromString "0000412f-0000-6e53-0000-6fde00001ffa"))),
                            (Id (fromJust (UUID.fromString "000035d8-0000-190b-0000-3f6a00004698"))),
                            (Id (fromJust (UUID.fromString "00004a5d-0000-1532-0000-7c0f000057a8"))),
                            (Id (fromJust (UUID.fromString "00001eda-0000-7b4f-0000-35d800001e6f"))),
                            (Id (fromJust (UUID.fromString "000079aa-0000-1359-0000-42b8000036a9"))),
                            (Id (fromJust (UUID.fromString "00001b31-0000-356b-0000-379b000048ef"))),
                            (Id (fromJust (UUID.fromString "0000649d-0000-04a0-0000-6dac00001c6d"))),
                            (Id (fromJust (UUID.fromString "00003a75-0000-6289-0000-274d00001220"))),
                            (Id (fromJust (UUID.fromString "00003ffb-0000-1dcc-0000-3ad40000209c"))),
                            (Id (fromJust (UUID.fromString "00007243-0000-40bf-0000-6cd1000079ca"))),
                            (Id (fromJust (UUID.fromString "000003ef-0000-0ac8-0000-1a060000698d"))),
                            (Id (fromJust (UUID.fromString "00005a61-0000-3900-0000-4b5d00007ea6"))),
                            (Id (fromJust (UUID.fromString "00001ebb-0000-22ef-0000-4df700007541"))),
                            (Id (fromJust (UUID.fromString "00005dc2-0000-68ba-0000-2bd0000010a8"))),
                            (Id (fromJust (UUID.fromString "00001e9c-0000-24ba-0000-0f8e000016b6"))),
                            (Id (fromJust (UUID.fromString "0000480d-0000-0b25-0000-6f8700001bcf"))),
                            (Id (fromJust (UUID.fromString "00006d2e-0000-7890-0000-77e600007c77"))),
                            (Id (fromJust (UUID.fromString "00005702-0000-2392-0000-643e00000389"))),
                            (Id (fromJust (UUID.fromString "000041a6-0000-52a9-0000-41ce00003ead"))),
                            (Id (fromJust (UUID.fromString "000026a1-0000-0fd3-0000-4aa2000012e7"))),
                            (Id (fromJust (UUID.fromString "00000820-0000-54c4-0000-48490000065b"))),
                            (Id (fromJust (UUID.fromString "000026ea-0000-4310-0000-7c61000078ea"))),
                            (Id (fromJust (UUID.fromString "00005134-0000-19cc-0000-32fe00006ccb"))),
                            (Id (fromJust (UUID.fromString "00006c9f-0000-5750-0000-3d5c00000149"))),
                            (Id (fromJust (UUID.fromString "00004772-0000-793d-0000-0b4d0000087f"))),
                            (Id (fromJust (UUID.fromString "000074ee-0000-5b53-0000-640000005536")))
                          ]
                      }
                  )
              )
