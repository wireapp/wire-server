...
testObject_UserClients_user_12 = UserClients {userClients = fromList [((Id (fromJust (UUID.fromString "00000731-0000-23a5-0000-23bc00003dd5"))), fromList [ClientId {client = "1"}, ClientId {client = "7"}, ClientId {client = "8"}, ClientId {client = "b"}, ClientId {client = "e"}])]}
...
testObject_UserClients_user_14 = UserClients {userClients = fromList [((Id (fromJust (UUID.fromString "00001130-0000-01e5-0000-3c24000015c6"))), fromList [ClientId {client = "18"}, ClientId {client = "1f"}, ClientId {client = "a"}])]}

testObject_UserClients_user_15 :: UserClients
testObject_UserClients_user_15 = UserClients {userClients = fromList [((Id (fromJust (UUID.fromString "000004e9-0000-307b-0000-1ab300006689"))), fromList [ClientId {client = "6c"}, ClientId {client = "946"}])]}

testObject_UserClients_user_16 :: UserClients
testObject_UserClients_user_16 = UserClients {userClients = fromList [((Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000700000007"))), fromList []), ((Id (fromJust (UUID.fromString "00000002-0000-0005-0000-000600000007"))), fromList [ClientId {client = "0"}, ClientId {client = "1"}]), ((Id (fromJust (UUID.fromString "00000002-0000-0008-0000-000300000000"))), fromList [ClientId {client = "2"}, ClientId {client = "4"}]), ((Id (fromJust (UUID.fromString "00000005-0000-0002-0000-000100000006"))), fromList [])]}
...
testObject_UserClients_user_19 = UserClients {userClients = fromList [((Id (fromJust (UUID.fromString "000025db-0000-66c4-0000-7f3f00001ba5"))), fromList [])]}
