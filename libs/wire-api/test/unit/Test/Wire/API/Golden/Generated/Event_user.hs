...
testObject_Event_user_18 =
  ( Event
      ...
      ( ( EdMembersLeave
            ( UserIdList
                { mUsers =
                    [ (Id (fromJust (UUID.fromString "00003fab-0000-40b8-0000-3b0c000014ef"))),
                      (Id (fromJust (UUID.fromString "00001c48-0000-29ae-0000-62fc00001479"))),
                      (Id (fromJust (UUID.fromString "00003254-0000-4f74-0000-6fc400003a01"))),
                      (Id (fromJust (UUID.fromString "000051f3-0000-077d-0000-1b3d00003745"))),
                      (Id (fromJust (UUID.fromString "000073a6-0000-7dec-0000-673c00005911"))),
                      (Id (fromJust (UUID.fromString "0000535c-0000-3949-0000-14aa000076cb"))),
                      (Id (fromJust (UUID.fromString "0000095f-0000-696f-0000-5ee200000ace"))),
                      (Id (fromJust (UUID.fromString "00003861-0000-132e-0000-502500005207"))),
                      (Id (fromJust (UUID.fromString "00007be5-0000-251a-0000-469400006f8d"))),
                      (Id (fromJust (UUID.fromString "000078f6-0000-7e08-0000-56d10000390e"))),
                      (Id (fromJust (UUID.fromString "0000517f-0000-26ef-0000-24c100002ae0"))),
                      (Id (fromJust (UUID.fromString "000001c6-0000-16c9-0000-58ea00005d5e"))),
                      (Id (fromJust (UUID.fromString "0000485b-0000-208e-0000-272200005214"))),
                      (Id (fromJust (UUID.fromString "00004d24-0000-439c-0000-618c00001e77"))),
                      (Id (fromJust (UUID.fromString "000077b4-0000-74a4-0000-26570000353e"))),
                      (Id (fromJust (UUID.fromString "0000332a-0000-430c-0000-5fbc00001ca8"))),
                      (Id (fromJust (UUID.fromString "000059c9-0000-6597-0000-667a00005744"))),
                      (Id (fromJust (UUID.fromString "00005777-0000-7a37-0000-6e22000052d2"))),
                      (Id (fromJust (UUID.fromString "0000430d-0000-4970-0000-0a9c00007b88"))),
                      (Id (fromJust (UUID.fromString "0000530a-0000-305f-0000-71a0000035d4"))),
                      (Id (fromJust (UUID.fromString "000005b8-0000-2691-0000-3a6000007dfb"))),
                      (Id (fromJust (UUID.fromString "00003c9c-0000-0780-0000-7ad500001db8"))),
                      (Id (fromJust (UUID.fromString "0000679a-0000-59cf-0000-279100003e58"))),
                      (Id (fromJust (UUID.fromString "00005aba-0000-14f5-0000-5c2e0000642f"))),
                      (Id (fromJust (UUID.fromString "000016b2-0000-56e8-0000-584600006914")))
                    ]
                }
            )
        )
...
testObject_Event_user_20 =
  ( Event
      ...
      ( ( EdMembersLeave
            ( UserIdList
                { mUsers =
                    [ (Id (fromJust (UUID.fromString "00002e78-0000-23d9-0000-1cba00005025"))),
                      (Id (fromJust (UUID.fromString "00003293-0000-6991-0000-533700000e73"))),
                      (Id (fromJust (UUID.fromString "000075b1-0000-2e89-0000-6262000067a9"))),
                      (Id (fromJust (UUID.fromString "00007f94-0000-39fc-0000-28c5000028ed"))),
                      (Id (fromJust (UUID.fromString "000041f3-0000-3886-0000-735900007499"))),
                      (Id (fromJust (UUID.fromString "00004014-0000-675c-0000-688600003ed7"))),
                      (Id (fromJust (UUID.fromString "00002e75-0000-74cd-0000-529a000008c7"))),
                      (Id (fromJust (UUID.fromString "00000cea-0000-4b67-0000-4a2600007dae"))),
                      (Id (fromJust (UUID.fromString "00006b72-0000-1fae-0000-6647000025d0"))),
                      (Id (fromJust (UUID.fromString "00003c64-0000-4b1f-0000-7bc900001c31"))),
                      (Id (fromJust (UUID.fromString "00002cd3-0000-4520-0000-0d8c00004a16"))),
                      (Id (fromJust (UUID.fromString "00003e8f-0000-66a2-0000-067600002d8f"))),
                      (Id (fromJust (UUID.fromString "00004544-0000-0ce2-0000-1c2300007fbc"))),
                      (Id (fromJust (UUID.fromString "000071ef-0000-44f4-0000-7dc500002e5f"))),
                      (Id (fromJust (UUID.fromString "00007e40-0000-7f3a-0000-45a300002aee"))),
                      (Id (fromJust (UUID.fromString "00006eec-0000-4bb0-0000-271000001e9f"))),
                      (Id (fromJust (UUID.fromString "00001893-0000-272e-0000-5ccc0000561f"))),
                      (Id (fromJust (UUID.fromString "00004d81-0000-2d5f-0000-43ec00005771"))),
                      (Id (fromJust (UUID.fromString "00002521-0000-1a18-0000-3bc200005ce2"))),
                      (Id (fromJust (UUID.fromString "000005f2-0000-3b01-0000-070000005296"))),
                      (Id (fromJust (UUID.fromString "0000411b-0000-224b-0000-32650000061a"))),
                      (Id (fromJust (UUID.fromString "00004880-0000-3a0b-0000-56b10000398a"))),
                      (Id (fromJust (UUID.fromString "00002d6b-0000-4f28-0000-11110000309a"))),
                      (Id (fromJust (UUID.fromString "0000357d-0000-2963-0000-7bb000002734"))),
                      (Id (fromJust (UUID.fromString "00000f40-0000-657c-0000-7d25000019df"))),
                      (Id (fromJust (UUID.fromString "00006350-0000-630b-0000-5f560000503e")))
                    ]
                }
            )
        )
