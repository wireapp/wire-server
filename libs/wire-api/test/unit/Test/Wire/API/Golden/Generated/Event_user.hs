...
testObject_Event_user_2 = (Event (ConvAccessUpdate) ((Id (fromJust (UUID.fromString "0000064d-0000-7a7f-0000-5749000029e1")))) ((Id (fromJust (UUID.fromString "00006a88-0000-2acb-0000-6aa0000061b2")))) (read "1864-06-05 23:01:18.769 UTC") ((EdConvAccessUpdate (ConversationAccessUpdate {cupAccess = [InviteAccess, LinkAccess, PrivateAccess, InviteAccess, InviteAccess], cupAccessRole = ActivatedAccessRole}))))

testObject_Event_user_3 :: Event
testObject_Event_user_3 = (Event (OtrMessageAdd) ((Id (fromJust (UUID.fromString "00006f8c-0000-00d6-0000-1568000001e9")))) ((Id (fromJust (UUID.fromString "00004b11-0000-5504-0000-55d800002188")))) (read "1864-04-27 15:44:23.844 UTC") ((EdOtrMessage (OtrMessage {otrSender = ClientId {client = "c"}, otrRecipient = ClientId {client = "f"}, otrCiphertext = "", otrData = Just ">\33032\SI\30584"}))))

testObject_Event_user_4 :: Event
testObject_Event_user_4 = (Event (ConvCodeDelete) ((Id (fromJust (UUID.fromString "00004f04-0000-3939-0000-472d0000316b")))) ((Id (fromJust (UUID.fromString "00007c90-0000-766a-0000-01b700002ab7")))) (read "1864-05-12 00:59:09.2 UTC") (EdConvCodeDelete))
...
testObject_Event_user_6 = (Event (ConvMessageTimerUpdate) ((Id (fromJust (UUID.fromString "00001fdb-0000-3127-0000-23ef00007183")))) ((Id (fromJust (UUID.fromString "0000705a-0000-0b62-0000-425c000049c8")))) (read "1864-05-09 05:44:41.382 UTC") ((EdConvMessageTimerUpdate (ConversationMessageTimerUpdate {cupMessageTimer = Just (Ms {ms = 5029817038083912})}))))

testObject_Event_user_7 :: Event
testObject_Event_user_7 = (Event (Typing) ((Id (fromJust (UUID.fromString "00006ac1-0000-543e-0000-7c8f00000be7")))) ((Id (fromJust (UUID.fromString "0000355a-0000-2979-0000-083000002d5e")))) (read "1864-04-18 05:01:13.761 UTC") ((EdTyping (TypingData {tdStatus = StoppedTyping}))))

testObject_Event_user_8 :: Event
testObject_Event_user_8 = (Event (ConvCodeDelete) ((Id (fromJust (UUID.fromString "00000892-0000-53c7-0000-0c870000027a")))) ((Id (fromJust (UUID.fromString "000008e8-0000-43fa-0000-4dd1000034cc")))) (read "1864-06-08 15:19:01.916 UTC") (EdConvCodeDelete))
...
testObject_Event_user_12 = (Event (ConvDelete) ((Id (fromJust (UUID.fromString "00007474-0000-2a7b-0000-125900006ac9")))) ((Id (fromJust (UUID.fromString "00000795-0000-709d-0000-11270000007a")))) (read "1864-05-23 17:16:29.326 UTC") (EdConvDelete))

testObject_Event_user_13 :: Event
testObject_Event_user_13 = (Event (OtrMessageAdd) ((Id (fromJust (UUID.fromString "00006355-0000-5f6e-0000-592c0000680c")))) ((Id (fromJust (UUID.fromString "000029eb-0000-06f8-0000-514100000a84")))) (read "1864-05-21 03:22:42.926 UTC") ((EdOtrMessage (OtrMessage {otrSender = ClientId {client = "1f"}, otrRecipient = ClientId {client = "4"}, otrCiphertext = "\1016351\FS!kO5", otrData = Just "sz"}))))

testObject_Event_user_14 :: Event
testObject_Event_user_14 = (Event (ConvReceiptModeUpdate) ((Id (fromJust (UUID.fromString "00000b98-0000-618d-0000-19e200004651")))) ((Id (fromJust (UUID.fromString "00004bee-0000-45a0-0000-2c0300005726")))) (read "1864-05-01 11:57:35.123 UTC") ((EdConvReceiptModeUpdate (ConversationReceiptModeUpdate {cruReceiptMode = ReceiptMode {unReceiptMode = -10505}}))))
...
testObject_Event_user_16 = (Event (ConvAccessUpdate) ((Id (fromJust (UUID.fromString "00004b59-0000-55d6-0000-5aad00007373")))) ((Id (fromJust (UUID.fromString "0000211e-0000-0b37-0000-563100003a5d")))) (read "1864-05-24 00:49:37.413 UTC") ((EdConvAccessUpdate (ConversationAccessUpdate {cupAccess = [], cupAccessRole = ActivatedAccessRole}))))

testObject_Event_user_17 :: Event
testObject_Event_user_17 = (Event (Typing) ((Id (fromJust (UUID.fromString "00006ac8-0000-1342-0000-76880000021d")))) ((Id (fromJust (UUID.fromString "0000145f-0000-2ce0-0000-4ca800006c72")))) (read "1864-04-17 07:39:54.846 UTC") ((EdTyping (TypingData {tdStatus = StoppedTyping}))))
