...
testObject_OtherMember_user_3 = OtherMember {omQualifiedId = Qualified (Id (fromJust (UUID.fromString "0000001d-0000-0012-0000-001f0000001f"))) domain, omService = Nothing, omConvRoleName = (fromJust (parseRoleName "224ynn27l35zqag2j8wx3jte0mtacwjx5gqfj8bu6v6z4iab5stg5fu4k7mviu1oi5sgmw3kovmgx6rxtfrzz72"))}
...
testObject_OtherMember_user_13 = OtherMember {omQualifiedId = Qualified (Id (fromJust (UUID.fromString "00000008-0000-0009-0000-000d00000011"))) domain, omService = Just (ServiceRef {_serviceRefId = (Id (fromJust (UUID.fromString "00000004-0000-0004-0000-000000000001"))), _serviceRefProvider = (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000100000001")))}), omConvRoleName = (fromJust (parseRoleName "clxtcuty2d1g_clojjevjpb5ca4a1"))}

testObject_OtherMember_user_14 :: OtherMember
testObject_OtherMember_user_14 = OtherMember {omQualifiedId = Qualified (Id (fromJust (UUID.fromString "00000016-0000-000c-0000-000e00000016"))) domain, omService = Nothing, omConvRoleName = (fromJust (parseRoleName "gxe_4agkvb3"))}

testObject_OtherMember_user_15 :: OtherMember
testObject_OtherMember_user_15 = OtherMember {omQualifiedId = Qualified (Id (fromJust (UUID.fromString "0000000d-0000-001f-0000-00180000001c"))) domain, omService = Nothing, omConvRoleName = (fromJust (parseRoleName "vp25612u_4o84sy2rigmst6j7zd54d6502f0zogeb2zm93b5vcdcf5z8mm_0by9syvet_u_7a"))}

testObject_OtherMember_user_16 :: OtherMember
testObject_OtherMember_user_16 = OtherMember {omQualifiedId = Qualified (Id (fromJust (UUID.fromString "00000014-0000-001e-0000-000600000008"))) domain, omService = Nothing, omConvRoleName = (fromJust (parseRoleName "89u0cp528kwlognk222yl5epk322mwjgip8k4atbko1u_q_3mmlalbdxtbrfdysnp0mii7dugiujclxbil1cjq1"))}
