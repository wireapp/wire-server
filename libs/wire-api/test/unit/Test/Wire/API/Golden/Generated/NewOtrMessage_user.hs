...
testObject_NewOtrMessage_user_2 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "3"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
      ...
      newOtrNativePush = False,
      newOtrTransient = True,
      newOtrNativePriority = Just LowPriority,
      newOtrData = Just "97",
        ...
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
                { userClientMap =
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000200000004"))),
...
testObject_NewOtrMessage_user_4 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "5"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
                { userClientMap =
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000000-0000-0000-0000-000300000004"))),
                          fromList [(ClientId {client = "0"}, "e"), (ClientId {client = "1"}, "")]
                        )
                      ]
                }
          },
      ...
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000001-0000-0001-0000-000000000000"))),
            (Id (fromJust (UUID.fromString "00000004-0000-0001-0000-000100000000")))
          ]
    }
...
testObject_NewOtrMessage_user_5 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "6"},
        ...
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
                { userClientMap =
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000004-0000-0002-0000-000100000002"))),
                          fromList [(ClientId {client = "2"}, "Y")]
                        )
                      ]
                }
          },
      ...
      newOtrNativePriority = Just LowPriority,
      newOtrData = Just "J\1055328",
      newOtrReportMissing = Nothing
    }

testObject_NewOtrMessage_user_6 :: NewOtrMessage
testObject_NewOtrMessage_user_6 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "8"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
      ...
      newOtrTransient = False,
      newOtrNativePriority = Just LowPriority,
      newOtrData = Just "-;\1036053L",
      newOtrReportMissing = Just []
    }

testObject_NewOtrMessage_user_7 :: NewOtrMessage
testObject_NewOtrMessage_user_7 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "1"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
                    ...
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000200000000"))),
                        ...
                        ( (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000002"))),
                          fromList [(ClientId {client = "0"}, "\ETX")]
                        )
                      ]
                }
          },
      ...
      newOtrData = Just "",
      newOtrReportMissing = Just [(Id (fromJust (UUID.fromString "00000000-0000-0001-0000-000300000004")))]
    }

testObject_NewOtrMessage_user_8 :: NewOtrMessage
testObject_NewOtrMessage_user_8 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "1"},
      newOtrRecipients =
        OtrRecipients
...
testObject_NewOtrMessage_user_9 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "0"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
...
testObject_NewOtrMessage_user_10 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "0"},
      newOtrRecipients =
        OtrRecipients
      ...
      newOtrNativePriority = Just HighPriority,
      newOtrData = Just "",
      newOtrReportMissing = Just [(Id (fromJust (UUID.fromString "00000002-0000-0003-0000-000100000003")))]
    }

testObject_NewOtrMessage_user_11 :: NewOtrMessage
testObject_NewOtrMessage_user_11 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "8"},
      newOtrRecipients =
        OtrRecipients
                ...
                { userClientMap =
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000003-0000-0004-0000-000000000001"))),
                          fromList [(ClientId {client = "3"}, "\NAK\19757")]
                        )
                      ]
                }
          },
      ...
      newOtrTransient = True,
      newOtrNativePriority = Just HighPriority,
      newOtrData = Just "\ETBa\173224\NAK",
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000000000002"))),
            (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000100000003"))),
            (Id (fromJust (UUID.fromString "00000002-0000-0004-0000-000400000004"))),
            (Id (fromJust (UUID.fromString "00000003-0000-0004-0000-000400000004")))
          ]
    }

testObject_NewOtrMessage_user_12 :: NewOtrMessage
testObject_NewOtrMessage_user_12 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "1"},
      newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList []}},
      newOtrNativePush = False,
...
testObject_NewOtrMessage_user_13 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "5"},
      newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList []}},
      newOtrNativePush = False,
      ...
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000001-0000-0004-0000-000000000002"))),
            ...
            (Id (fromJust (UUID.fromString "00000001-0000-0003-0000-000300000000"))),
            (Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000000000004")))
          ]
    }
      ...
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000001-0000-0002-0000-000100000000"))),
            (Id (fromJust (UUID.fromString "00000003-0000-0004-0000-000100000003"))),
            (Id (fromJust (UUID.fromString "00000002-0000-0003-0000-000200000004")))
          ]
    }

testObject_NewOtrMessage_user_16 :: NewOtrMessage
testObject_NewOtrMessage_user_16 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "7"},
      newOtrRecipients =
        OtrRecipients
          { otrRecipientsMap =
              UserClientMap
                { userClientMap =
                    fromList
                      [ ( (Id (fromJust (UUID.fromString "00000002-0000-0000-0000-000300000002"))),
                          fromList [(ClientId {client = "0"}, "g2")]
                        )
                      ]
                }
          },
...
testObject_NewOtrMessage_user_17 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "2"},
      newOtrRecipients =
        OtrRecipients
...
testObject_NewOtrMessage_user_19 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "3"},
      ...
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000002-0000-0002-0000-000300000001"))),
            (Id (fromJust (UUID.fromString "00000003-0000-0001-0000-000000000000")))
          ]
    }

testObject_NewOtrMessage_user_20 :: NewOtrMessage
testObject_NewOtrMessage_user_20 =
  NewOtrMessage
    { newOtrSender = ClientId {client = "2"},
      newOtrRecipients =
        OtrRecipients
      ...
      newOtrReportMissing =
        Just
          [ (Id (fromJust (UUID.fromString "00000002-0000-0001-0000-000000000004"))),
            (Id (fromJust (UUID.fromString "00000003-0000-0004-0000-000000000001")))
          ]
    }
