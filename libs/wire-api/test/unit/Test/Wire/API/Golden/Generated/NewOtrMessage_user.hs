...
testObject_NewOtrMessage_user_1 = NewOtrMessage {newOtrSender = ClientId {client = "0"}, newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList [((Id (fromJust (UUID.fromString "00000001-0000-0000-0000-000400000003"))),fromList [(ClientId {client = "0"},"#"),(ClientId {client = "1"},"")])]}}, newOtrNativePush = True, newOtrTransient = False, newOtrNativePriority = Just HighPriority, newOtrData = Just ",k|", newOtrReportMissing = Nothing}
testObject_NewOtrMessage_user_2 :: NewOtrMessage
testObject_NewOtrMessage_user_2 = NewOtrMessage {newOtrSender = ClientId {client = "4"}, newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList []}}, newOtrNativePush = False, newOtrTransient = False, newOtrNativePriority = Just LowPriority, newOtrData = Nothing, newOtrReportMissing = Nothing}
...
testObject_NewOtrMessage_user_4 = NewOtrMessage {newOtrSender = ClientId {client = "3"}, newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList [((Id (fromJust (UUID.fromString "00000002-0000-0003-0000-000100000001"))),fromList [(ClientId {client = "1"},"")])]}}, newOtrNativePush = False, newOtrTransient = True, newOtrNativePriority = Just LowPriority, newOtrData = Just "", newOtrReportMissing = Just [(Id (fromJust (UUID.fromString "00000002-0000-0002-0000-000100000000"))),(Id (fromJust (UUID.fromString "00000004-0000-0004-0000-000200000000"))),(Id (fromJust (UUID.fromString "00000003-0000-0002-0000-000400000001")))]}
testObject_NewOtrMessage_user_5 :: NewOtrMessage
testObject_NewOtrMessage_user_5 = NewOtrMessage {newOtrSender = ClientId {client = "4"}, newOtrRecipients = OtrRecipients {otrRecipientsMap = UserClientMap {userClientMap = fromList []}}, newOtrNativePush = True, newOtrTransient = False, newOtrNativePriority = Just HighPriority, newOtrData = Nothing, newOtrReportMissing = Nothing}
