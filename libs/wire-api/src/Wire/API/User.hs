...
connectedProfile :: EmailVisibility (Maybe (TeamId, TeamMember)) -> User -> UserLegalHoldStatus -> UserProfile
connectedProfile emailVisibilityConfig u legalHoldStatus =
  let isEmailVisible = case emailVisibilityConfig of
...
publicProfile u legalHoldStatus =
  ...
  let UserProfile
        ...
        } = connectedProfile EmailVisibleToSelf u legalHoldStatus
   in UserProfile
