...
connectedProfile :: EmailVisibilityConfigWithViewer -> User -> UserLegalHoldStatus -> UserProfile
connectedProfile emailVisibilityConfigAndViewer u legalHoldStatus =
