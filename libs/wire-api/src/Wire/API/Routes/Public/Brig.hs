  ...
  Named
    ...
    :<|> Named
           ...
           ( Summary "Search for users"
               ...
               :> QueryParam' '[Optional, Strict, Description "Only user types. Omitted or empty (type=) means no filtering."] "type" (CommaSeparatedList UserType)
...
type MultipleCipherSuitesParamV7 =
  QueryParam'
    [ Optional,
      Strict,
    ...
    :> ( Named
           ...
           :<|> Named
                  ...
                  ( "claim"
                      :> Summary "Claim one key package for each client of the given user"
                      :> From 'V8
                      :> Description "Only key packages for the specified ciphersuite are claimed."
                      :> ZLocalUser
                      :> ZOptClient
                      :> QualifiedCaptureUserId "user"
                      :> CipherSuiteParam
