  ...
  schema =
    Schema.object
      ...
      ( WireIdP
          ...
          <*> _replacedBy Schema..= Schema.field "replacedBy" (Schema.nullable (Schema.unnamed Schema.schema))
          <*> _handle Schema..= Schema.field "handle" Schema.schema
          <*> _domain Schema..= Schema.field "domain" (Schema.nullable (Schema.unnamed Schema.schema))
      )
