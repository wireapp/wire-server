...
models =
  [ Call.Config.modelRtcConfiguration,
    ...
    Team.Feature.modelTeamFeatureStatusNoConfig Team.Feature.TeamFeatureLegalHold,
    Team.Feature.modelTeamFeatureStatusNoConfig Team.Feature.TeamFeatureSSO,
    Team.Feature.modelTeamFeatureStatusNoConfig Team.Feature.TeamFeatureSearchVisibility,
    Team.Feature.modelTeamFeatureStatusNoConfig Team.Feature.TeamFeatureValidateSAMLEmails,
    Team.Feature.modelTeamFeatureStatusNoConfig Team.Feature.TeamFeatureDigitalSignatures,
    Team.Feature.modelTeamFeatureStatusWithConfig Team.Feature.TeamFeatureAppLock Team.Feature.modelTeamFeatureAppLockConfig,
