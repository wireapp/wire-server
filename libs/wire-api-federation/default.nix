...
, errors, exceptions, gitignoreSource, hspec, hspec-discover
, http-media, http-types, http2, HUnit, imports, kan-extensions
, lens, lib, lifted-base, metrics-wai, mtl, network, QuickCheck
, retry, schema-profunctor, servant, servant-client
, servant-client-core, servant-server, singletons, sop-core
, streaming-commons, swagger2, template-haskell, text, time
, time-manager, tls, transformers, types-common, uuid
