...
inMemoryUserSubsystemInterpreter =
  interpret \case
    ...
    InternalUpdateSearchIndex {} -> error "InternalUpdateSearchIndex: implement on demand (userSubsystemInterpreter)"
    InternalBumpWriteTimeAndUpdateSearchIndex {} -> error "InternalBumpWriteTimeAndUpdateSearchIndex: implement on demand (userSubsystemInterpreter)"
