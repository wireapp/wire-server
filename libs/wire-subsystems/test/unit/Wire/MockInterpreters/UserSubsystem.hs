...
userSubsystemTestInterpreter initialUsers =
  interpret \case
    ...
    ChangeAccountStatus _ _ -> error "ChangeAccountStatus: implement on demand (userSubsystemInterpreter)"
...
toProfile u = mkUserProfileWithEmail (userEmail u) UserTypeRegular u UserLegalHoldDisabled
