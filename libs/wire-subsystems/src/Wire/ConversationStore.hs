...
data ConversationStore m a where
  ...
  InsertConversationDescription :: ConvId -> ConversationDescription -> ConversationStore m (Maybe ConversationDescription)
  GetConversationDescription :: ConvId -> ConversationStore m (Maybe ConversationDescription)
  UpdateConversationDescription :: ConvId -> ConversationDescriptionUpdate -> ConversationStore m (Maybe ConversationDescription)
