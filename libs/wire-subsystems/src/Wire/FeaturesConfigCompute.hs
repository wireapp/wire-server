...
data FeaturesConfigCompute m a where
  ResolveGenericDbFeature ::
    ...
    LockableFeature cfg ->
    DbFeature cfg ->
    FeaturesConfigCompute m (LockableFeature cfg)
  ...
  ResolveLegalhold ::
    ...
    FeaturesConfigCompute m (LockableFeature LegalholdConfig)
  ResolveConferenceCalling ::
    TeamId ->
    LockableFeature ConferenceCallingConfig ->
    DbFeature ConferenceCallingConfig ->
    FeaturesConfigCompute m (LockableFeature ConferenceCallingConfig)
  ResolveConferenceCallingUser ::
    UserId ->
    FeaturesConfigCompute m (LockableFeature ConferenceCallingConfig)
  ResolveExposeInvitationURLsToTeamAdmin ::
    TeamId ->
    LockableFeature ExposeInvitationURLsToTeamAdminConfig ->
    DbFeature ExposeInvitationURLsToTeamAdminConfig ->
    FeaturesConfigCompute m (LockableFeature ExposeInvitationURLsToTeamAdminConfig)
