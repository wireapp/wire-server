...
appSubsystemErrorToHttpError =
  StdError . \case
    ...
    AppSubsystemErrorUnauthorized -> Wai.mkError status401 "unauthorized" "User does have permission, but has not presented all credentials"
