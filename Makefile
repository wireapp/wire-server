...
sboms-nix-docker-images:
	...
	./hack/bin/create-nix-docker-image-sboms.sh tmp/sboms/nix-docker-images $(HELM_SEMVER) wireServer.imagesUnoptimizedNoDocs
	./hack/bin/create-nix-docker-image-sboms.sh tmp/sboms/nix-docker-images $(HELM_SEMVER) nginz
