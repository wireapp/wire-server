...
specMisc = do
    ...
    xdescribe "rule do disallow http idp urls." $ do  -- TODO: make somemeta non-deterministic,
                                                      -- otherwise repeated runs of this test will
                                                      -- clash with 'idp-already-in-use'
