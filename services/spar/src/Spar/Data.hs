...
deleteIdPConfig idp issuer team = do
  ...
  where
    ...
    selDefaultIdp = "SELECT idp FROM default_idp WHERE primary_key_always_default = 'default'"

    delDefaultIdp :: PrepQuery W () ()
    delDefaultIdp = "DELETE FROM default_idp WHERE primary_key_always_default = 'default'"
