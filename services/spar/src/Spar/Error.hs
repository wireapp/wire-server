...
sparToWaiError (SAML.CustomError SparNoRequestRefInResponse)    = Right $ Wai.Error status403 "server-error-unsupported-saml" "The IdP needs to provide an InResponseTo attribute in the top-level element of the response."
