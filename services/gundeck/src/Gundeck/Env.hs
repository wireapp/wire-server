...
data Env = Env
  { _reqId :: !RequestId,
    ...
    _natsChannel :: MVar NATS.NatsChannel
  }
...
createEnv o = do
  ...
  natsChannelMVar <- Q.mkNatsChannelMVar l (Just "gundeck") (o ^. nats)
  pure $! (rThread : rAdditionalThreads,) $! Env (RequestId defRequestId) o l n p r rAdditional a io mtbs natsChannelMVar
