{ mkDerivation, aeson, aeson-qq, amazonka, amazonka-sqs
, asn1-encoding, asn1-types, async, base, base64-bytestring, bilge
...
, saml2-web-sso, schema-profunctor, semigroups, servant
, servant-client, servant-client-core, servant-server
, servant-swagger, servant-swagger-ui, singletons, sop-core, split
...
, wire-message-proto-lens, x509, yaml
}:
mkDerivation {
  pname = "galley";
  version = "0.83.0";
  ...
  libraryHaskellDepends = [
    aeson amazonka amazonka-sqs asn1-encoding asn1-types async base
    base64-bytestring bilge binary blake2 brig-types bytestring
