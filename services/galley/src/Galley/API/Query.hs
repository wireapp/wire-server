...
getUnqualifiedConversationV8 lusr cnv = do
...
getConversation lusr cnv =
  foldQualified
    ...
    (fmap fromConversationV8 . getRemoteConversation lusr)
    cnv
...
getConversationV8 ::
  ...
  Qualified ConvId ->
  Sem r Public.ConversationV8
getConversationV8 lusr cnv = do
  foldQualified
    lusr
    (getUnqualifiedConversationV8 lusr . tUnqualified)
