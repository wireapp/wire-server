...
conversationAPI =
  mkNamedAPI @"get-unqualified-conversation" getUnqualifiedConversation
    ...
    <@> mkNamedAPI @"add-members-to-conversation-unqualified" (callsFed (callsFed (callsFed addMembersUnqualified)))
    <@> mkNamedAPI @"add-members-to-conversation-unqualified2" (callsFed (callsFed (callsFed addMembersUnqualifiedV2)))
    <@> mkNamedAPI @"add-members-to-conversation" (callsFed (callsFed (callsFed addMembers)))
    <@> mkNamedAPI @"join-conversation-by-id-unqualified" (callsFed (callsFed (joinConversationById @Cassandra)))
    <@> mkNamedAPI @"join-conversation-by-code-unqualified" (callsFed (callsFed (joinConversationByReusableCode @Cassandra)))
    ...
    <@> mkNamedAPI @"remove-member-unqualified" (callsFed (callsFed (callsFed (callsFed removeMemberUnqualified))))
    <@> mkNamedAPI @"remove-member" (callsFed (callsFed (callsFed (callsFed removeMemberQualified))))
    <@> mkNamedAPI @"update-other-member-unqualified" (callsFed (callsFed (callsFed updateOtherMemberUnqualified)))
    <@> mkNamedAPI @"update-other-member" (callsFed (callsFed (callsFed updateOtherMember)))
    <@> mkNamedAPI @"update-conversation-name-deprecated" (callsFed (callsFed (callsFed updateUnqualifiedConversationName)))
    <@> mkNamedAPI @"update-conversation-name-unqualified" (callsFed (callsFed (callsFed updateUnqualifiedConversationName)))
    <@> mkNamedAPI @"update-conversation-name" (callsFed (callsFed (callsFed updateConversationName)))
    <@> mkNamedAPI @"update-conversation-message-timer-unqualified" (callsFed (callsFed (callsFed updateConversationMessageTimerUnqualified)))
    <@> mkNamedAPI @"update-conversation-message-timer" (callsFed (callsFed (callsFed updateConversationMessageTimer)))
    <@> mkNamedAPI @"update-conversation-receipt-mode-unqualified" (callsFed (callsFed (callsFed (callsFed updateConversationReceiptModeUnqualified))))
    <@> mkNamedAPI @"update-conversation-receipt-mode" (callsFed (callsFed (callsFed (callsFed updateConversationReceiptMode))))
    <@> mkNamedAPI @"update-conversation-access-unqualified" (callsFed (callsFed (callsFed updateConversationAccessUnqualified)))
    <@> mkNamedAPI @"update-conversation-access@v2" (callsFed (callsFed (callsFed updateConversationAccess)))
    <@> mkNamedAPI @"update-conversation-access" (callsFed (callsFed (callsFed updateConversationAccess)))
