...
legalHoldEnabledViaServerConfig :: Error
legalHoldEnabledViaServerConfig = Error status403 "cannot-change-legalhold-settings" "legal hold is enabled via server config and cannot be changed"
