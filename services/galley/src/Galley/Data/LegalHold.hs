...
createSettings :: LegalHoldService -> Galley ()
createSettings (LegalHoldService tid url fpr) = undefined

getSettings :: TeamId -> Galley LegalHoldService
getSettings = undefined

removeSettings :: TeamId -> Galley ()
