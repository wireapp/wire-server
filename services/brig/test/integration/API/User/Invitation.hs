...
testInvitationCodeExists brig = do
    ...
    postUser "dilbert" (Just "someoneelse@wearezeta.com") invCode Nothing Nothing brig !!! do
...
testInvitationInvalidCode brig = do
    ...
    postUser "dilbert" (Just "foo7@wearezeta.com") (Just code1) Nothing Nothing brig !!! do
        const 400 === statusCode
    ...
    postUser "dilbert" (Just "foo7@wearezeta.com") (Just code2) Nothing Nothing brig !!! do
        const 400 === statusCode
        const (Just "invalid-invitation-code") === fmap Error.label . decodeBody
