...
createUserSpar new = do
  ...
  -- Add to team
  userTeam <- withExceptT CreateUserSparRegistrationError $ addUserToTeamSSO account tid (UAuthIdentity $ undefined ident) (newUserSparRole new)
...
-- 'LegacyUserSSOId' can still do this if they also have an 'Email', 'Phone', and/or password.  Otherwise,
