...
certEnrollmentError CertEnrollmentError = StdError $ Wai.mkError status400 "generic-cer-enrollment-error" "generic error" --todo(leif): implement all possible errors
