...
getDomainRegistrationH ::
  ...
  Domain ->
  Handler r (DomainRegistrationResponse v)
...
getGroupsInternalH tid nameContains mbStartIndex mbCount =
  lift . liftSem $ getGroupsInternal tid nameContains mbStartIndex mbCount
