...
data TeamActivationEmailTemplate
  = TeamActivationEmailTemplate
...
data LoginCallTemplate
  = LoginCallTemplate
      { loginCallText :: !Template
      }

data DeletionSmsTemplate
  = DeletionSmsTemplate
