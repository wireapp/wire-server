...
, federator, file-embed, file-embed-lzma, filepath, fsnotify
, galley-types, geoip2, gitignoreSource, gundeck-types, hashable
, HaskellNet, HaskellNet-SSL, hscim, HsOpenSSL
, HsOpenSSL-x509-system, html-entities, http-api-data, http-client
, http-client-openssl, http-client-tls, http-media
, http-reverse-proxy, http-types, imports
, insert-ordered-containers, iproute, iso639, jwt-tools, lens
...
, polysemy-plugin, polysemy-wire-zoo, process, proto-lens
, QuickCheck, random, random-shuffle, raw-strings-qq, resource-pool
, resourcet, retry, ropes, safe, safe-exceptions, saml2-web-sso
, schema-profunctor, scientific, scrypt, servant, servant-client
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    extra file-embed file-embed-lzma filepath fsnotify galley-types
    geoip2 gundeck-types hashable HaskellNet HaskellNet-SSL HsOpenSSL
    ...
    iso639 jwt-tools lens lens-aeson metrics-core metrics-wai mime
    mime-mail mmorph MonadRandom mtl multihash mwc-random network
    network-conduit-tls optparse-applicative pem polysemy
    polysemy-plugin polysemy-wire-zoo proto-lens random-shuffle
  ...
  executableHaskellDepends = [
    ...
    mime MonadRandom mtl network optparse-applicative pem polysemy
    polysemy-wire-zoo process proto-lens QuickCheck random
    random-shuffle raw-strings-qq retry safe saml2-web-sso servant
    servant-client servant-client-core spar string-conversions tasty
    tasty-cannon tasty-hunit temporary text time tinylog transformers
    types-common types-common-aws types-common-journal unliftio
    unordered-containers uri-bytestring uuid vector wai wai-extra
    wai-route wai-utilities warp warp-tls wire-api wire-api-federation
    yaml zauth
  ];
  testHaskellDepends = [
