...
, optparse-applicative, pem, polysemy, polysemy-plugin
, polysemy-wire-zoo, process, proto-lens, QuickCheck, random
, random-shuffle, raw-strings-qq, resource-pool, resourcet, retry
, ropes, safe, safe-exceptions, saml2-web-sso, schema-profunctor
, scientific, scrypt, servant, servant-client, servant-client-core
, servant-server, servant-swagger, servant-swagger-ui
, sodium-crypto-sign, spar, split, ssl-util, statistics
, stomp-queue, string-conversions, swagger, swagger2, tagged, tasty
, tasty-cannon, tasty-hunit, tasty-quickcheck, template, temporary
, text, text-icu-translit, time, tinylog, transformers
...
mkDerivation {
  ...
  executableHaskellDepends = [
    ...
    network optparse-applicative pem polysemy polysemy-wire-zoo process
    proto-lens QuickCheck random random-shuffle raw-strings-qq retry
    safe saml2-web-sso servant servant-client servant-client-core spar
