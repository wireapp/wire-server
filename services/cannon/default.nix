...
, random, retry, safe-exceptions, servant-conduit, servant-server
, strict, tasty, tasty-hunit, tasty-quickcheck, text, tinylog
, types-common, unix, unliftio, uuid, vector, wai, wai-extra
, wai-utilities, warp, websockets, wire-api
}:
mkDerivation {
  pname = "cannon";
  version = "0.31.0";
  ...
  libraryHaskellDepends = [
    ...
    servant-conduit servant-server strict text tinylog types-common
    unix unliftio vector wai wai-extra wai-utilities warp websockets
    wire-api
  ];
  executableHaskellDepends = [ base imports types-common ];
  testHaskellDepends = [
    async base bytestring imports metrics-wai QuickCheck random tasty
    tasty-hunit tasty-quickcheck types-common uuid wire-api
  ];
