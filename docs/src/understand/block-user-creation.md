...
On instances with restricted user creation, the site operator with access to the internal REST API can still circumvent the restriction: just log into a brig service pod and follow the steps in `hack/bin/create_test_team_admins.sh`.
