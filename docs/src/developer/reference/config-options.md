...
example how to do this for the Kubernetes solution *K8ssandra* and a `Secret`
generated by `cert-manager`. The corresponding Cassandra options are described
in Cassandra's documentation:
