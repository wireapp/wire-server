...
3. Add `https://nix-build.zinfra.io` as build substituter with trusted public key `nix-build.zinfra.io-1:N4+kZzixOCzHn68l72wRqYOBfFiSinze6wUgreZPdcI=` to your nix config. See https://nix.dev/guides/recipes/add-binary-cache.html.
